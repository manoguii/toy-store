...
var clearStyle = function clearStyle2(selector) {
  var element = import_global.default.document.getElementById(selector);
  if (element && element.parentElement) {
    element.parentElement.removeChild(element);
  }
};
var addOutlineStyles = function addOutlineStyles2(selector, css) {
  var existingStyle = import_global.default.document.getElementById(selector);
  if (existingStyle) {
    if (existingStyle.innerHTML !== css) {
      existingStyle.innerHTML = css;
    }
  } else {
    var style = import_global.default.document.createElement("style");
    style.setAttribute("id", selector);
    style.innerHTML = css;
    import_global.default.document.head.appendChild(style);
  }
};
...
// ../../node_modules/@storybook/addon-outline/dist/esm/preset/preview.js
...
//# sourceMappingURL=@storybook_addon-outline_preview__js.js.map
