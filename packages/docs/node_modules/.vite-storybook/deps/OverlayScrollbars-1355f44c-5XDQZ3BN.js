...
import "./chunk-XE5TDMYW.js";
import "./chunk-OHMBV7PE.js";
import "./chunk-4YX4GBOW.js";
import "./chunk-4FKJMYA3.js";
import "./chunk-X2LPIKKR.js";
import "./chunk-GVAQFHRJ.js";
import "./chunk-PVV6YIVF.js";
import {
  require_react
} from "./chunk-75WGAAO6.js";
import "./chunk-52JVDVI3.js";
import "./chunk-KVFJDTRJ.js";
import "./chunk-RUJMTQNF.js";
import "./chunk-TBCB4ZVT.js";
import "./chunk-4M5QWQBY.js";
import "./chunk-HMOQY6QS.js";
import "./chunk-XOFNJGJF.js";
import "./chunk-MRQRI6NV.js";
import "./chunk-CDNBU3WE.js";
import "./chunk-SDDELZZC.js";
import "./chunk-IYYMJTP5.js";
import {
  require_dist
} from "./chunk-4H7W7BOF.js";
import "./chunk-47BVRTCU.js";
import "./chunk-2UIPFT7T.js";
import "./chunk-MUVKSGSX.js";
import "./chunk-3R3GPAZT.js";
import "./chunk-W5E77KMD.js";
import "./chunk-6EKJX75R.js";
import "./chunk-Z5HQPNBE.js";
import "./chunk-XDOF6HPC.js";
import "./chunk-3NYG53LK.js";
import "./chunk-3LW7PNYD.js";
import "./chunk-3BSVKPXT.js";
import "./chunk-ZFIZIYBE.js";
import {
  require_lib
} from "./chunk-46ZIBCZ2.js";
import "./chunk-QTUELRGM.js";
import "./chunk-IK6U2MGX.js";
import "./chunk-WTTAXVBY.js";
import "./chunk-ETUEVWCZ.js";
import "./chunk-WJXYEWDG.js";
import "./chunk-AD5GLT2N.js";
import {
  require_memoizerific
} from "./chunk-ZPLF4ROR.js";
import "./chunk-47DPL6ZF.js";
import "./chunk-PZL5JMTE.js";
import "./chunk-UMGFALWA.js";
import "./chunk-4LV76HFX.js";
import "./chunk-CGCXURAF.js";
import "./chunk-OWLZC4NM.js";
import "./chunk-SPMAYKFJ.js";
import "./chunk-44JOYLHL.js";
import "./chunk-QDVNNMNY.js";
import "./chunk-U4A4RURD.js";
import "./chunk-APZ6C5NO.js";
import "./chunk-V3G3ESVH.js";
import "./chunk-LTD54ION.js";
import "./chunk-TJQOZE7S.js";
import {
...
import "./chunk-TICKQCY4.js";
import "./chunk-ACHUVI3R.js";
import {
  __toESM
...
(function(module) {
  (function(global, factory) {
  ...
  })(typeof window !== "undefined" ? window : commonjsGlobal, function(window2, document, undefined$1) {
    ...
    var COMPATIBILITY = function() {
      ...
      function bind(func, thisObj) {
        ...
        var fNOP = function fNOP2() {
        };
        var fBound = function fBound2() {
        ...
        one: function one(eventName, handler) {
          ...
          return this.each(function() {
            ...
            FakejQuery.each(eventName, function(i, oneEventName) {
              var oneHandler = function oneHandler2(e) {
                handler.call(this, e);
                el.off(oneEventName, oneHandler2);
              };
        ...
        contents: function contents() {
          ...
          this.each(function() {
            ...
            for (i = 0; i < childs[LEXICON.l]; i++) {
              contents2.push(childs[i]);
            }
          });
          return FakejQuery(contents2);
        },
    ...
    var PLUGIN = function() {
      ...
      var _pluginsOptions = function() {
        ...
        var convert = function convert2(template) {
          var recursive = function recursive2(obj) {
            var key;
            var val;
            var valType;
            for (key in obj) {
        ...
        return {
          ...
          _validate: function _validate(obj, template, writeErrors, diffObj) {
            ...
            var checkObjectProps = function checkObjectProps2(data, template2, diffData, validatedOptions2, validatedOptionsPrepared2, prevPropName) {
              for (var prop in template2) {
                if (template2[LEXICON.hOP](prop) && data[LEXICON.hOP](prop)) {
                  ...
                  if (templateIsComplex && dataValueType == TYPES.o) {
                    ...
                    checkObjectProps2(dataValue, templateValue, dataDiffValue, validatedOptions2[prop], validatedOptionsPrepared2[prop], propPrefix + prop);
      ...
      function OverlayScrollbarsInstance(pluginTargetElement, options, extensions, globals, autoUpdateLoop) {
          ...
          if (targetElement) {
            ...
            if (onElementResizedCallback) {
              ...
              if (targetElement[0] === _sizeObserverElementNative) {
                var directionChanged = function directionChanged2() {
        ...
        function createMutationObservers() {
          if (_supportMutationObserver) {
            ...
            var sizeAuto;
            var action;
            _mutationObserverHostCallback = function _mutationObserverHostCallback2(mutations) {
              var doUpdate = false;
            ...
            _mutationObserverContentCallback = function _mutationObserverContentCallback2(mutations) {
              var doUpdate = false;
              var mutation;
              if (_initialized && !_sleeping) {
                each(mutations, function() {
        ...
        function isSizeAffectingCSSProperty(propertyName) {
          ...
          var checkPropertyName = function checkPropertyName2(arr, name) {
            for (var i = 0; i < arr[LEXICON.l]; i++) {
              if (arr[i] === name)
                return true;
            }
        ...
        function update(updateHints) {
          ...
          var checkCacheAutoForce = function checkCacheAutoForce2() {
          ...
          var getHostSize = function getHostSize2() {
            return {
          ...
          if (hostSizeChanged || contentSizeChanged || textareaSizeChanged || cssDirectionChanged || boxSizingChanged || paddingAbsoluteChanged || widthAutoChanged || widthAuto || heightAutoChanged || heightAuto || ignoreOverlayScrollbarHidingChanged || overflowBehaviorChanged || clipAlwaysChanged || resizeChanged || scrollbarsVisibilityChanged || scrollbarsAutoHideChanged || scrollbarsDragScrollingChanged || scrollbarsClickScrollingChanged || textareaDynWidthChanged || textareaDynHeightChanged || textareaAutoWrappingChanged) {
            ...
            if (sizeAutoCapable) {
              ...
              var setContentGlueElementCSSfunction = function setContentGlueElementCSSfunction2(horizontal) {
            ...
            var setOverflowVariables = function setOverflowVariables2(horizontal) {
              var scrollbarVars = getScrollbarVars(horizontal);
            ...
            if (_nativeScrollbarIsOverlaid.x || _nativeScrollbarIsOverlaid.y) {
              ...
              if (hasOverflow.c || hideOverflow.c || contentScrollSize.c || cssDirectionChanged || widthAutoChanged || heightAutoChanged || widthAuto || heightAuto || ignoreOverlayScrollbarHidingChanged) {
                ...
                setContentElementCSS = function setContentElementCSS2(horizontal) {
                  var scrollbarVars = getScrollbarVars(horizontal);
                  var scrollbarVarsInverted = getScrollbarVars(!horizontal);
                  var xy = scrollbarVars._x_y;
            ...
            if (hostSizeChanged || hasOverflow.c || hideOverflow.c || contentScrollSize.c || overflowBehaviorChanged || boxSizingChanged || ignoreOverlayScrollbarHidingChanged || cssDirectionChanged || clipAlwaysChanged || heightAutoChanged) {
              ...
              setViewportCSS = function setViewportCSS2(horizontal) {
                var scrollbarVars = getScrollbarVars(horizontal);
                var scrollbarVarsInverted = getScrollbarVars(!horizontal);
                var xy = scrollbarVars._x_y;
                var XY = scrollbarVars._X_Y;
            ...
            var refreshScrollbarsVisibility = function refreshScrollbarsVisibility2(showX, showY) {
        ...
        function setupStructureDOM(destroy) {
          ...
          var adoptAttrsMap = {};
          var applyAdoptedAttrs = function applyAdoptedAttrs2() {
        ...
        function setupScrollbarsDOM(destroy) {
          var selectOrGenerateScrollbarDOM = function selectOrGenerateScrollbarDOM2(isHorizontal) {
        ...
        function setupScrollbarEvents(isHorizontal) {
          ...
          function onTrackMouseTouchDown(event) {
            if (onMouseTouchDownContinue(event)) {
              ...
              var scrollActionFinsished = function scrollActionFinsished2(transition) {
                if (_scrollbarsHandlesDefineScrollPos)
                  refreshScrollbarHandleOffset(isHorizontal, transition);
              };
              var scrollActionInstantFinished = function scrollActionInstantFinished2() {
                scrollActionFinsished();
                onHandleMouseTouchDownAction(event);
              };
              var scrollAction = function scrollAction2() {
                if (!_destroyed) {
                  ...
                  if (instantScroll) {
                    ...
                    if (finishedCondition) {
                      ...
                      trackTimeout = setTimeout(scrollAction2, timeoutDelay);
        ...
        function refreshScrollbarHandleOffset(isHorizontal, scrollOrTransition) {
          ...
          var getScrollRatio = function getScrollRatio2(base) {
            return isNaN(base / maxScroll) ? 0 : MATH.max(0, MATH.min(1, base / maxScroll));
          };
          var getHandleOffset = function getHandleOffset2(scrollRatio2) {
        ...
        function getCSSTransitionString(element) {
          ...
          var i = 0;
          var j;
          var splitCssStyleByComma = function splitCssStyleByComma2(str) {
            strResult = [];
        ...
        function createHostClassNameRegExp(withCurrClassNameOption, withOldClassNameOption) {
          ...
          var split;
          var appendix;
          var appendClasses = function appendClasses2(classes, condition) {
            appendix = "";
        ...
        function isHTMLElement(o) {
          ...
          return _typeof(wnd[strHTMLElement]) == TYPES.o ? o instanceof wnd[strHTMLElement] : o && _typeof(o) == TYPES.o && o !== null && o.nodeType === 1 && _typeof(o.nodeName) == TYPES.s;
        }
        ...
        _base.scroll = function(coordinates, duration, easing, complete) {
          ...
          var updateScrollbarInfos = function updateScrollbarInfos2() {
            if (doScrollLeft)
              refreshScrollbarHandleOffset(true);
            if (doScrollTop)
              refreshScrollbarHandleOffset(false);
          ...
          if (possibleElementIsJQuery || possibleElementIsHTMLElement) {
            ...
            if (finalElement[strLength] > 0) {
              ...
              if (settingsBlock.x != strBegin || settingsBlock.y != strBegin || settingsScroll.x == strIfNeeded || settingsScroll.y == strIfNeeded || _isRTL) {
                ...
                var finalizeBlock = function finalizeBlock2(isX) {
        ...
        _base.getState = function(stateProperty) {
          function prepare(obj2) {
            ...
            var changePropertyName = function changePropertyName2(from, to) {
...
var OverlayScrollbarsComponent = function OverlayScrollbarsComponent2(_a) {
  var _a$options = _a.options, options = _a$options === void 0 ? {} : _a$options, extensions = _a.extensions, className = _a.className, children = _a.children, rest = __rest(_a, ["options", "extensions", "className", "children"]);
  var osTargetRef = (0, import_react.useRef)();
  var osInstance = (0, import_react.useRef)();
...
function mergeHostClassNames(osInstance, className) {
  if (OverlayScrollbars.valid(osInstance)) {
    var _osInstance$getElemen = osInstance.getElements(), host = _osInstance$getElemen.host;
...
export {
  ...
  OverlayScrollbarsComponent as default
};
/*!
 * OverlayScrollbars
 ...
 * Date: 02.08.2020
 */
//# sourceMappingURL=OverlayScrollbars-1355f44c-5XDQZ3BN.js.map
