...
var require_iterators_core = __commonJS({
  "../../node_modules/core-js/internals/iterators-core.js"(exports, module) {
    ...
    if (!isCallable(IteratorPrototype[ITERATOR2])) {
      defineBuiltIn(IteratorPrototype, ITERATOR2, function() {
        return this;
      });
    }
    module.exports = {
  ...
  "../../node_modules/core-js/internals/iterator-define.js"(exports, module) {
    ...
    module.exports = function(Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED2) {
        ...
        if (CurrentIteratorPrototype !== Object.prototype && CurrentIteratorPrototype.next) {
          if (!IS_PURE && getPrototypeOf(CurrentIteratorPrototype) !== IteratorPrototype) {
            if (setPrototypeOf) {
              ...
              defineBuiltIn(CurrentIteratorPrototype, ITERATOR2, returnThis);
            }
          }
      ...
      if ((!IS_PURE || FORCED2) && IterablePrototype[ITERATOR2] !== defaultIterator) {
        defineBuiltIn(IterablePrototype, ITERATOR2, defaultIterator, { name: DEFAULT });
      }
  ...
  "../../node_modules/core-js/internals/collection.js"(exports, module) {
    ...
    module.exports = function(CONSTRUCTOR_NAME, wrapper, common) {
      ...
      var REPLACE = isForced(
        CONSTRUCTOR_NAME,
        !isCallable(NativeConstructor) || !(IS_WEAK || NativePrototype.forEach && !fails2(function() {
...
//# sourceMappingURL=chunk-QMQ6IYQF.js.map
