import {
  ...
  themes,
  useTheme
} from "./chunk-XE5TDMYW.js";
import {
  require_string_repeat
} from "./chunk-4YX4GBOW.js";
import {
  require_react
} from "./chunk-75WGAAO6.js";
import {
  require_delete_property_or_throw
} from "./chunk-KVFJDTRJ.js";
import {
  require_string_trim_forced
} from "./chunk-RUJMTQNF.js";
import {
  require_array_fill
} from "./chunk-SDDELZZC.js";
import {
  require_runtime
} from "./chunk-IYYMJTP5.js";
import {
  require_dist
} from "./chunk-4H7W7BOF.js";
import {
  require_string_trim
} from "./chunk-ZFIZIYBE.js";
import {
  require_lib
} from "./chunk-46ZIBCZ2.js";
import {
  require_memoizerific
} from "./chunk-ZPLF4ROR.js";
import {
  logger,
  once,
  require_es_regexp_exec
} from "./chunk-NFP7DPPX.js";
import {
...
var require_string_trim_end = __commonJS({
  "../../node_modules/core-js/internals/string-trim-end.js"(exports, module) {
    ...
    module.exports = forcedStringTrimMethod("trimEnd") ? function trimEnd2() {
      return $trimEnd(this);
    } : "".trimEnd;
  }
});
...
var require_es_string_trim_right = __commonJS({
  "../../node_modules/core-js/modules/es.string.trim-right.js"() {
    ...
    $7({ target: "String", proto: true, name: "trimEnd", forced: "".trimRight !== trimEnd2 }, {
      trimRight: trimEnd2
    });
  }
});
...
var require_to_index = __commonJS({
  "../../node_modules/core-js/internals/to-index.js"(exports, module) {
    ...
    module.exports = function(it2) {
      if (it2 === void 0)
        return 0;
      var number = toIntegerOrInfinity2(it2);
...
var require_array_buffer = __commonJS({
  "../../node_modules/core-js/internals/array-buffer.js"(exports, module) {
    ...
    var NativeArrayBuffer2 = global3[ARRAY_BUFFER2];
    ...
    var addGetter = function(Constructor, key2) {
      defineProperty2(Constructor[PROTOTYPE], key2, { get: function() {
    ...
    var set = function(view, count, index2, conversion, value2, isLittleEndian) {
      var intIndex = toIndex(index2);
      var store = getInternalState(view);
      if (intIndex + count > store.byteLength)
        throw RangeError2(WRONG_INDEX);
      var bytes = getInternalState(store.buffer).bytes;
      var start2 = intIndex + store.byteOffset;
      var pack = conversion(+value2);
      for (var i2 = 0; i2 < count; i2++)
        bytes[start2 + i2] = pack[isLittleEndian ? i2 : count - i2 - 1];
    };
    if (!NATIVE_ARRAY_BUFFER) {
      ...
      defineBuiltIns(DataViewPrototype, {
        ...
        setInt8: function setInt8(byteOffset, value2) {
          set(this, 1, byteOffset, packInt8, value2);
        },
        setUint8: function setUint8(byteOffset, value2) {
          set(this, 1, byteOffset, packInt8, value2);
        },
        setInt16: function setInt16(byteOffset, value2) {
          set(this, 2, byteOffset, packInt16, value2, arguments.length > 2 ? arguments[2] : void 0);
        },
        setUint16: function setUint16(byteOffset, value2) {
          set(this, 2, byteOffset, packInt16, value2, arguments.length > 2 ? arguments[2] : void 0);
        },
        setInt32: function setInt32(byteOffset, value2) {
          set(this, 4, byteOffset, packInt32, value2, arguments.length > 2 ? arguments[2] : void 0);
        },
        setUint32: function setUint32(byteOffset, value2) {
          set(this, 4, byteOffset, packInt32, value2, arguments.length > 2 ? arguments[2] : void 0);
        },
        setFloat32: function setFloat32(byteOffset, value2) {
          set(this, 4, byteOffset, packFloat32, value2, arguments.length > 2 ? arguments[2] : void 0);
        },
        setFloat64: function setFloat64(byteOffset, value2) {
          set(this, 8, byteOffset, packFloat64, value2, arguments.length > 2 ? arguments[2] : void 0);
        }
      });
    } else {
      INCORRECT_ARRAY_BUFFER_NAME = PROPER_FUNCTION_NAME && NativeArrayBuffer2.name !== ARRAY_BUFFER2;
      if (!fails(function() {
        ...
        for (keys2 = getOwnPropertyNames(NativeArrayBuffer2), j2 = 0; keys2.length > j2; ) {
          if (!((key = keys2[j2++]) in $ArrayBuffer)) {
            createNonEnumerableProperty($ArrayBuffer, key, NativeArrayBuffer2[key]);
          }
        }
        ArrayBufferPrototype.constructor = $ArrayBuffer;
      } else if (INCORRECT_ARRAY_BUFFER_NAME && CONFIGURABLE_FUNCTION_NAME) {
        createNonEnumerableProperty(NativeArrayBuffer2, "name", ARRAY_BUFFER2);
      }
      ...
      if (testView.getInt8(0) || !testView.getInt8(1))
        defineBuiltIns(DataViewPrototype, {
          setInt8: function setInt8(byteOffset, value2) {
            $setInt8(this, byteOffset, value2 << 24 >> 24);
          },
          setUint8: function setUint8(byteOffset, value2) {
            $setInt8(this, byteOffset, value2 << 24 >> 24);
          }
...
$5({ target: "String", proto: true, forced: forcedStringHTMLMethod("small") }, {
...
var PolishedError = function(_Error) {
  ...
  function PolishedError2(code2) {
    ...
    if (false) {
      ...
      _this = _Error.call(this, format$1.apply(void 0, [ERRORS[code2]].concat(args))) || this;
    }
...
var headerCommon = function headerCommon2(_ref2) {
  ...
  return { margin: "20px 0 8px", padding: 0, cursor: "text", position: "relative", color: theme.color.defaultText, "&:first-of-type": { marginTop: 0, paddingTop: 0 }, "&:hover a.anchor": { textDecoration: "none" }, "& tt, & code": { fontSize: "inherit" } };
};
var codeCommon = function codeCommon2(_ref3) {
  var theme = _ref3.theme;
  return { lineHeight: 1, margin: "0 2px", padding: "3px 5px", whiteSpace: "nowrap", borderRadius: 3, fontSize: theme.typography.size.s2 - 1, border: theme.base === "light" ? "1px solid ".concat(theme.color.mediumlight) : "1px solid ".concat(theme.color.darker), color: theme.base === "light" ? curriedTransparentize$1(0.1, theme.color.defaultText) : curriedTransparentize$1(0.3, theme.color.defaultText), backgroundColor: theme.base === "light" ? theme.color.lighter : theme.color.border };
};
var withReset = function withReset2(_ref4) {
  var theme = _ref4.theme;
  return { fontFamily: theme.typography.fonts.base, fontSize: theme.typography.size.s3, margin: 0, WebkitFontSmoothing: "antialiased", MozOsxFontSmoothing: "grayscale", WebkitTapHighlightColor: "rgba(0, 0, 0, 0)", WebkitOverflowScrolling: "touch" };
};
...
var Link$1 = function Link$12(_a) {
  ...
  return import_react.default.createElement("a", Object.assign({ href, target }, props), children);
};
var A$2 = styled(Link$1)(withReset, function(_ref5) {
  var theme = _ref5.theme;
  return { fontSize: "inherit", lineHeight: "24px", color: theme.color.secondary, textDecoration: "none", "&.absent": { color: "#cc0000" }, "&.anchor": { display: "block", paddingLeft: 30, marginLeft: -30, cursor: "pointer", position: "absolute", top: 0, left: 0, bottom: 0 } };
});
var Blockquote = styled.blockquote(withReset, withMargin, function(_ref6) {
  var theme = _ref6.theme;
  return { borderLeft: "4px solid ".concat(theme.color.medium), padding: "0 15px", color: theme.color.dark, "& > :first-of-type": { marginTop: 0 }, "& > :last-child": { marginBottom: 0 } };
});
var Wrapper$8 = styled.div(withReset, function(_ref7) {
  var theme = _ref7.theme;
  return { backgroundColor: theme.base === "light" ? "rgba(0,0,0,.01)" : "rgba(255,255,255,.01)", borderRadius: theme.appBorderRadius, border: "1px dashed ".concat(theme.appBorderColor), display: "flex", alignItems: "center", justifyContent: "center", padding: 20, margin: "25px 0 40px", color: curriedTransparentize$1(0.3, theme.color.defaultText), fontSize: theme.typography.size.s2 };
});
var EmptyBlock = function EmptyBlock2(props) {
  return import_react.default.createElement(Wrapper$8, Object.assign({}, props, { className: "docblock-emptyblock" }));
};
var LazySyntaxHighlighter = (0, import_react.lazy)(function() {
  return import("./syntaxhighlighter-b07b042a-Z6KJUZYC.js");
});
var LazySyntaxHighlighterWithFormatter = (0, import_react.lazy)(function() {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return Promise.all([import("./syntaxhighlighter-b07b042a-Z6KJUZYC.js"), import("./formatter-0d5cb0eb-P7GGCDPO.js")]);
          case 2:
            ...
            return _context.abrupt("return", { default: function _default(props) {
              return import_react.default.createElement(SyntaxHighlighter3, Object.assign({}, props, { formatter }));
            } });
          case 7:
          case "end":
...
var SyntaxHighlighter = function SyntaxHighlighter2(props) {
  return import_react.default.createElement(import_react.Suspense, { fallback: import_react.default.createElement("div", null) }, props.format !== false ? import_react.default.createElement(LazySyntaxHighlighterWithFormatter, Object.assign({}, props)) : import_react.default.createElement(LazySyntaxHighlighter, Object.assign({}, props)));
};
...
var SourceSkeletonWrapper = styled.div(function(_ref9) {
  ...
  return { background: theme.background.content, borderRadius: theme.appBorderRadius, border: "1px solid ".concat(theme.appBorderColor), boxShadow: theme.base === "light" ? "rgba(0, 0, 0, 0.10) 0 1px 3px 0" : "rgba(0, 0, 0, 0.20) 0 2px 5px 0", margin: "25px 0 40px", padding: "20px 20px 20px 22px" };
});
var SourceSkeletonPlaceholder = styled.div(function(_ref10) {
  var theme = _ref10.theme;
  return _defineProperty2({ animation: "".concat(theme.animation.glow, " 1.5s ease-in-out infinite"), background: theme.appBorderColor, height: 17, marginTop: 1, width: "60%" }, "&:first-child", { margin: 0 });
});
var SourceSkeleton = function SourceSkeleton2() {
  return import_react.default.createElement(SourceSkeletonWrapper, null, import_react.default.createElement(SourceSkeletonPlaceholder, null), import_react.default.createElement(SourceSkeletonPlaceholder, { style: { width: "80%" } }), import_react.default.createElement(SourceSkeletonPlaceholder, { style: { width: "30%" } }), import_react.default.createElement(SourceSkeletonPlaceholder, { style: { width: "80%" } }));
};
var Source = function Source2(props) {
  var isLoading = props.isLoading, error2 = props.error;
  if (isLoading) {
    return import_react.default.createElement(SourceSkeleton, null);
  }
  if (error2) {
    return import_react.default.createElement(EmptyBlock, null, error2);
  }
  var _a = props, language = _a.language, code2 = _a.code, dark = _a.dark, format3 = _a.format, rest = __rest(_a, ["language", "code", "dark", "format"]);
  var syntaxHighlighter = import_react.default.createElement(StyledSyntaxHighlighter, Object.assign({ bordered: true, copyable: true, format: format3, language, className: "docblock-source" }, rest), code2);
...
var Code = function Code2(_a) {
  ...
  var childrenArray = import_react.Children.toArray(children);
  var isInlineCode = !childrenArray.filter(isReactChildString).some(function(child) {
    return child.match(isInlineCodeRegex);
  });
  if (isInlineCode) {
    return import_react.default.createElement(DefaultCodeBlock, Object.assign({}, props, { className }), childrenArray);
  }
  return import_react.default.createElement(StyledSyntaxHighlighter, Object.assign({ bordered: true, copyable: true, language: (_b = language === null || language === void 0 ? void 0 : language[1]) !== null && _b !== void 0 ? _b : "plaintext", format: false }, props), children);
};
...
var LI = styled.li(withReset, function(_ref20) {
  ...
  return { fontSize: theme.typography.size.s2, color: theme.color.defaultText, lineHeight: "24px", "& + li": { marginTop: ".25em" }, "& ul, & ol": { marginTop: ".25em", marginBottom: 0 }, "& code": codeCommon({ theme }) };
});
...
var P$1 = styled.p(withReset, withMargin, function(_ref21) {
  ...
  return { fontSize: theme.typography.size.s2, lineHeight: "24px", color: theme.color.defaultText, "& code": codeCommon({ theme }) };
});
...
var components$1 = { h1: function h1(props) {
  return import_react.default.createElement(H1, Object.assign({}, nameSpaceClassNames(props, "h1")));
}, h2: function h2(props) {
  return import_react.default.createElement(H2, Object.assign({}, nameSpaceClassNames(props, "h2")));
}, h3: function h3(props) {
  return import_react.default.createElement(H3, Object.assign({}, nameSpaceClassNames(props, "h3")));
}, h4: function h4(props) {
  return import_react.default.createElement(H4, Object.assign({}, nameSpaceClassNames(props, "h4")));
}, h5: function h5(props) {
  return import_react.default.createElement(H5, Object.assign({}, nameSpaceClassNames(props, "h5")));
}, h6: function h6(props) {
  return import_react.default.createElement(H6, Object.assign({}, nameSpaceClassNames(props, "h6")));
}, pre: function pre(props) {
  return import_react.default.createElement(Pre, Object.assign({}, nameSpaceClassNames(props, "pre")));
}, a: function a(props) {
  return import_react.default.createElement(A$2, Object.assign({}, nameSpaceClassNames(props, "a")));
}, hr: function hr(props) {
  return import_react.default.createElement(HR, Object.assign({}, nameSpaceClassNames(props, "hr")));
}, dl: function dl(props) {
  return import_react.default.createElement(DL, Object.assign({}, nameSpaceClassNames(props, "dl")));
}, blockquote: function blockquote(props) {
  return import_react.default.createElement(Blockquote, Object.assign({}, nameSpaceClassNames(props, "blockquote")));
}, table: function table(props) {
  return import_react.default.createElement(Table$1, Object.assign({}, nameSpaceClassNames(props, "table")));
}, img: function img(props) {
  return import_react.default.createElement(Img, Object.assign({}, nameSpaceClassNames(props, "img")));
}, div: function div(props) {
  return import_react.default.createElement(Div, Object.assign({}, nameSpaceClassNames(props, "div")));
}, span: function span(props) {
  return import_react.default.createElement(Span, Object.assign({}, nameSpaceClassNames(props, "span")));
}, li: function li(props) {
  return import_react.default.createElement(LI, Object.assign({}, nameSpaceClassNames(props, "li")));
}, ul: function ul(props) {
  return import_react.default.createElement(UL, Object.assign({}, nameSpaceClassNames(props, "ul")));
}, ol: function ol(props) {
  return import_react.default.createElement(OL, Object.assign({}, nameSpaceClassNames(props, "ol")));
}, p: function p(props) {
  return import_react.default.createElement(P$1, Object.assign({}, nameSpaceClassNames(props, "p")));
}, code: function code(props) {
  return import_react.default.createElement(Code, Object.assign({}, nameSpaceClassNames(props, "code")));
}, tt: function tt(props) {
  return import_react.default.createElement(TT, Object.assign({}, nameSpaceClassNames(props, "tt")));
}, resetwrapper: function resetwrapper(props) {
  return import_react.default.createElement(ResetWrapper, Object.assign({}, nameSpaceClassNames(props, "resetwrapper")));
} };
var BadgeWrapper = styled.div(function(_ref25) {
  var theme = _ref25.theme;
  return { display: "inline-block", fontSize: 11, lineHeight: "12px", alignSelf: "center", padding: "4px 12px", borderRadius: "3em", fontWeight: theme.typography.weight.bold };
}, { svg: { height: 12, width: 12, marginRight: 4, marginTop: -2, path: { fill: "currentColor" } } }, function(_ref26) {
  var theme = _ref26.theme, status = _ref26.status;
  switch (status) {
    case "critical": {
...
var Badge = function Badge2(_a) {
  var props = __rest(_a, []);
  return import_react.default.createElement(BadgeWrapper, Object.assign({}, props));
};
...
var Icons = (0, import_react.memo)(function(_a) {
  var icon = _a.icon, symbol = _a.symbol, props = __rest(_a, ["icon", "symbol"]);
  return import_react.default.createElement(Svg, Object.assign({ viewBox: "0 0 1024 1024" }, props), symbol ? import_react.default.createElement("use", { xlinkHref: "#icon--".concat(symbol) }) : import_react.default.createElement(Path, { d: icons[icon] }));
});
var Symbols = (0, import_react.memo)(function(_ref28) {
  var _ref28$icons = _ref28.icons, keys2 = _ref28$icons === void 0 ? Object.keys(icons) : _ref28$icons;
  return import_react.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { position: "absolute", width: 0, height: 0 }, "data-chromatic": "ignore" }, keys2.map(function(key) {
    return import_react.default.createElement("symbol", { id: "icon--".concat(key), key }, import_react.default.createElement(Path, { d: icons[key] }));
  }));
});
var LEFT_BUTTON = 0;
...
var A$1 = styled.a(function(_ref31) {
  ...
  var theme = _ref32.theme, secondary = _ref32.secondary, tertiary = _ref32.tertiary;
  var colors;
  if (secondary) {
  ...
  var theme = _ref34.theme, inverse = _ref34.inverse;
  return inverse ? { color: theme.color.lightest, "svg path": { fill: theme.color.lightest }, "&:hover": { color: theme.color.lighter, "svg path": { fill: theme.color.lighter } }, "&:active": { color: theme.color.light, "svg path": { fill: theme.color.light } } } : {};
}, function(_ref35) {
...
var ActionBar = function ActionBar2(_a) {
  ...
  return import_react.default.createElement(Container$1, Object.assign({}, props), actionItems.map(function(_ref40, index2) {
    var title = _ref40.title, className = _ref40.className, onClick = _ref40.onClick, disabled = _ref40.disabled;
    return import_react.default.createElement(ActionButton, { key: index2, className, onClick, disabled }, title);
  }));
};
var toNumber = function toNumber2(input) {
  return typeof input === "number" ? input : Number(input);
};
var Container = styled.div(function(_ref41) {
  var theme = _ref41.theme, col = _ref41.col, _ref41$row = _ref41.row, row = _ref41$row === void 0 ? 1 : _ref41$row;
  return col ? _defineProperty2({ display: "inline-block", verticalAlign: "inherit", "& > *": { marginLeft: col * theme.layoutMargin, verticalAlign: "inherit" } }, "& > *:first-child", { marginLeft: 0 }) : _defineProperty2({ "& > *": { marginTop: row * theme.layoutMargin } }, "& > *:first-child", { marginTop: 0 });
}, function(_ref44) {
  var theme = _ref44.theme, outer = _ref44.outer, col = _ref44.col, row = _ref44.row;
  switch (true) {
    case !!(outer && col): {
...
var Spaced = function Spaced2(_a) {
  var col = _a.col, row = _a.row, outer = _a.outer, children = _a.children, rest = __rest(_a, ["col", "row", "outer", "children"]);
  var outerAmount = toNumber(typeof outer === "number" || !outer ? outer : col || row);
  return import_react.default.createElement(Container, Object.assign({ col, row, outer: outerAmount }, rest), children);
};
var Title$3 = styled.div(function(_ref45) {
  var theme = _ref45.theme;
  return { fontWeight: theme.typography.weight.bold };
});
...
var Placeholder = function Placeholder2(_a) {
  ...
  var _Children$toArray = import_react.Children.toArray(children), _Children$toArray2 = _slicedToArray(_Children$toArray, 2), title = _Children$toArray2[0], desc = _Children$toArray2[1];
  return import_react.default.createElement(Message$1, Object.assign({}, props), import_react.default.createElement(Title$3, null, title), desc && import_react.default.createElement(Desc$1, null, desc));
};
var GlobalScrollAreaStyles = (0, import_react.lazy)(function() {
  return import("./GlobalScrollAreaStyles-8793ce4a-VDMNOYHH.js");
});
var OverlayScrollbars = (0, import_react.lazy)(function() {
  return import("./OverlayScrollbars-1355f44c-5XDQZ3BN.js");
});
var Scroller = function Scroller2(_a) {
  var props = __rest(_a, ["horizontal", "vertical"]);
  return import_react.default.createElement(import_react.Suspense, { fallback: import_react.default.createElement("div", Object.assign({}, props)) }, import_react.default.createElement(GlobalScrollAreaStyles, null), import_react.default.createElement(OverlayScrollbars, Object.assign({ options: { scrollbars: { autoHide: "leave" } } }, props)));
};
...
function ZoomElement(_ref50) {
  ...
  var componentWrapperRef = (0, import_react.useRef)(null);
  var _useState = (0, import_react.useState)(0), _useState2 = _slicedToArray(_useState, 2), height = _useState2[0], setHeight = _useState2[1];
  ...
  return import_react.default.createElement(ZoomElementWrapper, { scale, height }, import_react.default.createElement("div", { ref: componentWrapperRef, className: "innerZoomElementWrapper" }, children));
}
...
var ButtonWrapper = styled.button(function(_ref51) {
  var small2 = _ref51.small, theme = _ref51.theme;
  return { border: 0, borderRadius: "3em", cursor: "pointer", display: "inline-block", overflow: "hidden", padding: small2 ? "8px 16px" : "13px 20px", position: "relative", textAlign: "center", textDecoration: "none", transition: "all 150ms ease-out", transform: "translate3d(0,0,0)", verticalAlign: "top", whiteSpace: "nowrap", userSelect: "none", opacity: 1, margin: 0, background: "transparent", fontSize: "".concat(small2 ? theme.typography.size.s1 : theme.typography.size.s2 - 1, "px"), fontWeight: theme.typography.weight.bold, lineHeight: "1", svg: { display: "inline-block", height: small2 ? 14 : 16, width: small2 ? 14 : 16, verticalAlign: "top", marginRight: small2 ? 4 : 6, marginTop: small2 ? -1 : -2, marginBottom: small2 ? -1 : -2, pointerEvents: "none", path: { fill: "currentColor" } } };
}, function(_ref52) {
  var disabled = _ref52.disabled;
  return disabled ? { cursor: "not-allowed !important", opacity: 0.5, "&:hover": { transform: "none" } } : {};
}, function(_ref53) {
  var containsIcon = _ref53.containsIcon, small2 = _ref53.small;
  return containsIcon ? Object.assign({ svg: { display: "block", margin: 0 } }, small2 ? { padding: 9 } : { padding: 12 }) : {};
}, function(_ref54) {
  var theme = _ref54.theme, primary = _ref54.primary, secondary = _ref54.secondary, gray = _ref54.gray;
  var color;
  if (gray) {
  ...
  return color ? { background: color, color: gray ? theme.color.darkest : theme.color.lightest, "&:hover": { background: curriedDarken$1(0.05, color) }, "&:active": { boxShadow: "rgba(0, 0, 0, 0.1) 0 0 0 3em inset" }, "&:focus": { boxShadow: "".concat(rgba(color, 1), " 0 1px 9px 2px"), outline: "none" }, "&:focus:hover": { boxShadow: "".concat(rgba(color, 0.2), " 0 8px 18px 0px") } } : {};
}, function(_ref55) {
  var theme = _ref55.theme, tertiary = _ref55.tertiary, inForm = _ref55.inForm, small2 = _ref55.small;
  return tertiary ? Object.assign(Object.assign({ background: theme.base === "light" ? curriedDarken$1(0.02, theme.input.background) : curriedLighten$1(0.02, theme.input.background), color: theme.input.color, boxShadow: "".concat(theme.input.border, " 0 0 0 1px inset"), borderRadius: theme.input.borderRadius }, inForm && small2 ? { padding: "10px 16px" } : {}), { "&:hover": Object.assign({ background: theme.base === "light" ? curriedDarken$1(0.05, theme.input.background) : curriedLighten$1(0.05, theme.input.background) }, inForm ? {} : { boxShadow: "rgba(0,0,0,.2) 0 2px 6px 0, rgba(0,0,0,.1) 0 0 0 1px inset" }), "&:active": { background: theme.input.background }, "&:focus": { boxShadow: "".concat(rgba(theme.color.secondary, 1), " 0 0 0 1px inset"), outline: "none" } }) : {};
}, function(_ref56) {
  var theme = _ref56.theme, outline = _ref56.outline;
  return outline ? { boxShadow: "".concat(curriedTransparentize$1(0.8, theme.color.defaultText), " 0 0 0 1px inset"), color: curriedTransparentize$1(0.3, theme.color.defaultText), background: "transparent", "&:hover, &:focus": { boxShadow: "".concat(curriedTransparentize$1(0.5, theme.color.defaultText), " 0 0 0 1px inset"), outline: "none" }, "&:active": { boxShadow: "".concat(curriedTransparentize$1(0.5, theme.color.defaultText), " 0 0 0 2px inset"), color: curriedTransparentize$1(0, theme.color.defaultText) } } : {};
}, function(_ref57) {
  var theme = _ref57.theme, outline = _ref57.outline, primary = _ref57.primary;
  var color = theme.color.primary;
  return outline && primary ? { boxShadow: "".concat(color, " 0 0 0 1px inset"), color, "svg path": { fill: color }, "&:hover": { boxShadow: "".concat(color, " 0 0 0 1px inset"), background: "transparent" }, "&:active": { background: color, boxShadow: "".concat(color, " 0 0 0 1px inset"), color: theme.color.tertiary }, "&:focus": { boxShadow: "".concat(color, " 0 0 0 1px inset, ").concat(rgba(color, 0.4), " 0 1px 9px 2px"), outline: "none" }, "&:focus:hover": { boxShadow: "".concat(color, " 0 0 0 1px inset, ").concat(rgba(color, 0.2), " 0 8px 18px 0px") } } : {};
}, function(_ref58) {
  var theme = _ref58.theme, outline = _ref58.outline, primary = _ref58.primary, secondary = _ref58.secondary;
  var color;
  if (secondary) {
    color = theme.color.secondary;
  } else if (primary) {
  ...
  return outline && color ? { boxShadow: "".concat(color, " 0 0 0 1px inset"), color, "svg path": { fill: color }, "&:hover": { boxShadow: "".concat(color, " 0 0 0 1px inset"), background: "transparent" }, "&:active": { background: color, boxShadow: "".concat(color, " 0 0 0 1px inset"), color: theme.color.tertiary }, "&:focus": { boxShadow: "".concat(color, " 0 0 0 1px inset, ").concat(rgba(color, 0.4), " 0 1px 9px 2px"), outline: "none" }, "&:focus:hover": { boxShadow: "".concat(color, " 0 0 0 1px inset, ").concat(rgba(color, 0.2), " 0 8px 18px 0px") } } : {};
});
var ButtonLink = ButtonWrapper.withComponent("a");
var Button$2 = Object.assign((0, import_react.forwardRef)(function(_a, ref) {
  var isLink = _a.isLink, children = _a.children, props = __rest(_a, ["isLink", "children"]);
  if (isLink) {
    return import_react.default.createElement(ButtonLink, Object.assign({}, props, { ref }), children);
  }
  return import_react.default.createElement(ButtonWrapper, Object.assign({}, props, { ref }), children);
}), { defaultProps: { isLink: false } });
var Wrapper$7 = styled.label(function(_ref59) {
  var theme = _ref59.theme;
  return { display: "flex", borderBottom: "1px solid ".concat(theme.appBorderColor), margin: "0 15px", padding: "8px 0", "&:last-child": { marginBottom: "3rem" } };
});
var Label$4 = styled.span(function(_ref60) {
  var theme = _ref60.theme;
  return { minWidth: 100, fontWeight: theme.typography.weight.bold, marginRight: 15, display: "flex", justifyContent: "flex-start", alignItems: "center", lineHeight: "16px" };
});
var Field = function Field2(_a) {
  var label = _a.label, children = _a.children, props = __rest(_a, ["label", "children"]);
  return import_react.default.createElement(Wrapper$7, Object.assign({}, props), label ? import_react.default.createElement(Label$4, null, import_react.default.createElement("span", null, label)) : null, children);
};
...
var useLatest = function useLatest2(value2) {
  var ref = (0, import_react.useRef)(value2);
  index$1(function() {
    ref.current = value2;
  });
  return ref;
...
var TextareaAutosize = function TextareaAutosize2(_ref, userRef) {
  ...
  var libRef = (0, import_react.useRef)(null);
  var ref = useComposedRef(libRef, userRef);
  var heightRef = (0, import_react.useRef)(0);
  var measurementsCacheRef = (0, import_react.useRef)();
  ...
  if (typeof document !== "undefined") {
    (0, import_react.useLayoutEffect)(resizeTextarea);
    useWindowResizeListener(resizeTextarea);
  }
  return (0, import_react.createElement)("textarea", _extends({}, props, { onChange: handleChange, ref }));
};
var index = (0, import_react.forwardRef)(TextareaAutosize);
var TextareaAutoResize = index;
var styleResets$1 = {
  appearance: "none",
  border: "0 none",
  boxSizing: "inherit",
...
var validation = function validation2(_ref64) {
  var valid = _ref64.valid, theme = _ref64.theme;
  switch (valid) {
    case "valid": {
...
var Input$1 = Object.assign(styled((0, import_react.forwardRef)(function(_a, ref) {
  var props = __rest(_a, ["size", "valid", "align"]);
  return import_react.default.createElement("input", Object.assign({}, props, { ref }));
}))(styles, sizes, alignment, validation, { minHeight: 32 }), { displayName: "Input" });
var Select = Object.assign(styled((0, import_react.forwardRef)(function(_a, ref) {
  var props = __rest(_a, ["size", "valid", "align"]);
  return import_react.default.createElement("select", Object.assign({}, props, { ref }));
}))(styles, sizes, validation, { height: 32, userSelect: "none", paddingRight: 20, appearance: "menulist" }), { displayName: "Select" });
var Textarea = Object.assign(styled((0, import_react.forwardRef)(function(_a, ref) {
  var props = __rest(_a, ["size", "valid", "align"]);
  return import_react.default.createElement(TextareaAutoResize, Object.assign({}, props, { ref }));
...
var ButtonStyled = styled((0, import_react.forwardRef)(function(_a, ref) {
  var props = __rest(_a, ["size", "valid", "align"]);
  return import_react.default.createElement(Button$2, Object.assign({}, props, { ref }));
}))(sizes, validation, {
  userSelect: "none",
  overflow: "visible",
  zIndex: 2,
...
var Button$1 = Object.assign((0, import_react.forwardRef)(function(props, ref) {
  return import_react.default.createElement(ButtonStyled, Object.assign({}, props, { tertiary: true, small: true, inForm: true }, { ref }));
}), { displayName: "Button" });
var Form = Object.assign(styled.form({ boxSizing: "border-box", width: "100%" }), { Field, Input: Input$1, Select, Textarea, Button: Button$1 });
var LazyWithTooltip = (0, import_react.lazy)(function() {
  return import("./WithTooltip-167e9982-3SJCWMUQ.js").then(function(mod) {
    return { default: mod.WithTooltip };
  });
});
var WithTooltip = function WithTooltip2(props) {
  return import_react.default.createElement(import_react.Suspense, { fallback: import_react.default.createElement("div", null) }, import_react.default.createElement(LazyWithTooltip, Object.assign({}, props)));
};
var LazyWithTooltipPure = (0, import_react.lazy)(function() {
  return import("./WithTooltip-167e9982-3SJCWMUQ.js").then(function(mod) {
    return { default: mod.WithTooltipPure };
  });
});
var WithTooltipPure = function WithTooltipPure2(props) {
  return import_react.default.createElement(import_react.Suspense, { fallback: import_react.default.createElement("div", null) }, import_react.default.createElement(LazyWithTooltipPure, Object.assign({}, props)));
};
var Title$2 = styled.div(function(_ref66) {
  var theme = _ref66.theme;
  return { fontWeight: theme.typography.weight.black };
});
var Desc = styled.span();
var Links = styled.div(function(_ref67) {
  var theme = _ref67.theme;
  return { marginTop: 8, textAlign: "center", "> *": { margin: "0 8px", fontWeight: theme.typography.weight.black } };
});
var Message = styled.div(function(_ref68) {
  var theme = _ref68.theme;
  return { color: theme.textColor, lineHeight: "18px" };
});
var MessageWrapper = styled.div({ padding: 15, width: 280, boxSizing: "border-box" });
var TooltipMessage = function TooltipMessage2(_ref69) {
  var title = _ref69.title, desc = _ref69.desc, links = _ref69.links;
  return import_react.default.createElement(MessageWrapper, null, import_react.default.createElement(Message, null, title && import_react.default.createElement(Title$2, null, title), desc && import_react.default.createElement(Desc, null, desc)), links && import_react.default.createElement(Links, null, links.map(function(_a) {
    var linkTitle = _a.title, other = __rest(_a, ["title"]);
    return import_react.default.createElement(Link, Object.assign({}, other, { key: linkTitle }), linkTitle);
  })));
};
TooltipMessage.defaultProps = { title: null, desc: null, links: null };
var Note = styled.div(function(_ref70) {
  var theme = _ref70.theme;
  return { padding: "2px 6px", lineHeight: "16px", fontSize: 10, fontWeight: theme.typography.weight.bold, color: theme.color.lightest, boxShadow: "0 0 5px 0 rgba(0, 0, 0, 0.3)", borderRadius: 4, whiteSpace: "nowrap", pointerEvents: "none", zIndex: -1, background: theme.base === "light" ? "rgba(60, 60, 60, 0.9)" : "rgba(20, 20, 20, 0.85)", margin: 6 };
});
var TooltipNote = function TooltipNote2(_a) {
  var note = _a.note, props = __rest(_a, ["note"]);
  return import_react.default.createElement(Note, Object.assign({}, props), note);
};
var Title$1 = styled(function(_a) {
  var rest = __rest(_a, ["active", "loading", "disabled"]);
  return import_react.default.createElement("span", Object.assign({}, rest));
})(function(_ref71) {
  ...
  var active = _ref72.active, theme = _ref72.theme;
  return active ? { color: theme.color.primary, fontWeight: theme.typography.weight.bold } : {};
}, function(_ref73) {
  var loading = _ref73.loading, theme = _ref73.theme;
  return loading ? Object.assign({ display: "inline-block", flex: "none" }, theme.animation.inlineGlow) : {};
}, function(_ref74) {
  var disabled = _ref74.disabled, theme = _ref74.theme;
...
var Right = styled.span({ "& svg": { transition: "all 200ms ease-out", opacity: 0, height: 12, width: 12, margin: "3px 0", verticalAlign: "top" }, "& path": { fill: "inherit" } }, function(_ref75) {
  var active = _ref75.active, theme = _ref75.theme;
...
var CenterText = styled.span({ flex: 1, textAlign: "center" }, function(_ref76) {
  var active = _ref76.active, theme = _ref76.theme;
  return active ? { color: theme.color.primary } : {};
}, function(_ref77) {
  var theme = _ref77.theme, disabled = _ref77.disabled;
  return disabled ? { color: theme.color.mediumdark } : {};
});
var Left = styled.span(function(_ref78) {
  var active = _ref78.active, theme = _ref78.theme;
  return active ? { "& svg": { opacity: 1 }, "& path": { fill: theme.color.primary } } : {};
});
var Item$3 = styled.a(function(_ref79) {
  var theme = _ref79.theme;
  return { fontSize: theme.typography.size.s1, transition: "all 150ms ease-out", color: curriedTransparentize$1(0.5, theme.color.defaultText), textDecoration: "none", cursor: "pointer", justifyContent: "space-between", lineHeight: "18px", padding: "7px 15px", display: "flex", alignItems: "center", "& > * + *": { paddingLeft: 10 }, "&:hover": { background: theme.background.hoverable }, "&:hover svg": { opacity: 1 } };
}, function(_ref80) {
  var disabled = _ref80.disabled;
  return disabled ? { cursor: "not-allowed" } : {};
});
var getItemProps = (0, import_memoizerific.default)(100)(function(onClick, href, LinkWrapper) {
  var result2 = {};
  if (onClick) {
...
var ListItem = function ListItem2(_a) {
  ...
  return import_react.default.createElement(Item$3, Object.assign({}, commonProps, rest, itemProps), left2 && import_react.default.createElement(Left, Object.assign({}, commonProps), left2), title || center ? import_react.default.createElement(Center, null, title && import_react.default.createElement(Title$1, Object.assign({}, commonProps, { loading }), title), center && import_react.default.createElement(CenterText, Object.assign({}, commonProps), center)) : null, right2 && import_react.default.createElement(Right, Object.assign({}, commonProps), right2));
};
ListItem.defaultProps = { loading: false, left: null, title: import_react.default.createElement("span", null, "Loading state"), center: null, right: null, active: false, disabled: false, href: null, LinkWrapper: null, onClick: null };
var List$2 = styled.div({ minWidth: 180, overflow: "hidden", overflowY: "auto", maxHeight: 13.5 * 32 }, function(_ref81) {
  var theme = _ref81.theme;
  return { borderRadius: theme.appBorderRadius * 2 };
});
var Item$2 = function Item$22(props) {
  var LinkWrapper = props.LinkWrapper, onClickFromProps = props.onClick, rest = __rest(props, ["LinkWrapper", "onClick"]);
  var title = rest.title, href = rest.href, active = rest.active;
  var onClick = (0, import_react.useCallback)(function(event) {
    onClickFromProps(event, rest);
  }, [onClickFromProps]);
  var hasOnClick = !!onClickFromProps;
  return import_react.default.createElement(ListItem, Object.assign({ title, active, href, LinkWrapper }, rest, hasOnClick ? { onClick } : {}));
};
var TooltipLinkList = function TooltipLinkList2(_ref82) {
  var links = _ref82.links, LinkWrapper = _ref82.LinkWrapper;
  return import_react.default.createElement(List$2, null, links.map(function(_a) {
    var isGatsby = _a.isGatsby, p3 = __rest(_a, ["isGatsby"]);
    return import_react.default.createElement(Item$2, Object.assign({ key: p3.id, LinkWrapper: isGatsby ? LinkWrapper : null }, p3));
  }));
};
...
var Bar$1 = styled(function(_ref85) {
  ...
  return import_react.default.createElement(ScrollArea, { horizontal: true, vertical: false, className }, children);
})(function(_ref86) {
  var theme = _ref86.theme;
  return { color: theme.barTextColor, width: "100%", height: 40, flexShrink: 0, overflow: "auto", overflowY: "hidden" };
}, function(_ref87) {
  var theme = _ref87.theme, border = _ref87.border;
  return border ? { boxShadow: "".concat(theme.appBorderColor, "  0 -1px 0 0 inset"), background: theme.barBg } : {};
});
...
var FlexBar = function FlexBar2(_a) {
  ...
  var _Children$toArray3 = import_react.Children.toArray(children), _Children$toArray4 = _slicedToArray(_Children$toArray3, 2), left2 = _Children$toArray4[0], right2 = _Children$toArray4[1];
  return import_react.default.createElement(Bar$1, Object.assign({}, rest), import_react.default.createElement(BarInner, { bgColor: backgroundColor }, import_react.default.createElement(Side, { left: true }, left2), right2 ? import_react.default.createElement(Side, { right: true }, right2) : null));
};
...
var ButtonOrLink = function ButtonOrLink2(_a) {
  ...
  return restProps.href != null ? import_react.default.createElement("a", Object.assign({}, restProps), children) : import_react.default.createElement("button", Object.assign({ type: "button" }, restProps), children);
};
var TabButton = styled(ButtonOrLink, { shouldForwardProp: isPropValid })({ whiteSpace: "normal", display: "inline-flex", overflow: "hidden", verticalAlign: "top", justifyContent: "center", alignItems: "center", textAlign: "center", textDecoration: "none", "&:empty": { display: "none" } }, function(_ref89) {
  ...
  return { padding: "0 15px", transition: "color 0.2s linear, border-bottom-color 0.2s linear", height: 40, lineHeight: "12px", cursor: "pointer", background: "transparent", border: "0 solid transparent", borderTop: "3px solid transparent", borderBottom: "3px solid transparent", fontWeight: "bold", fontSize: 13, "&:focus": { outline: "0 none", borderBottomColor: theme.color.secondary } };
}, function(_ref90) {
  var active = _ref90.active, textColor = _ref90.textColor, theme = _ref90.theme;
  return active ? { color: textColor || theme.barSelectedColor, borderBottomColor: theme.barSelectedColor } : { color: textColor || theme.barTextColor, borderBottomColor: "transparent" };
});
...
var IconButton = styled(ButtonOrLink, { shouldForwardProp: isPropValid })(function() {
  ...
  var active = _ref91.active, theme = _ref91.theme;
  return active ? { backgroundColor: theme.background.hoverable, color: theme.color.secondary } : {};
}, function(_ref92) {
  var disabled = _ref92.disabled, theme = _ref92.theme;
  return disabled ? { opacity: 0.5, cursor: "not-allowed" } : { "&:hover, &:focus-visible": { background: curriedTransparentize$1(0.88, theme.color.secondary), color: theme.color.secondary }, "&:focus-visible": { outline: auto }, "&:focus:not(:focus-visible)": { outline: "none" } };
});
IconButton.displayName = "IconButton";
var IconPlaceholder = styled.div(function(_ref93) {
  var theme = _ref93.theme;
  return { width: 14, height: 14, backgroundColor: theme.appBorderColor, animation: "".concat(theme.animation.glow, " 1.5s ease-in-out infinite") };
});
...
var IconButtonSkeleton = function IconButtonSkeleton2() {
  return import_react.default.createElement(IconButtonSkeletonWrapper, null, import_react.default.createElement(IconPlaceholder, null));
};
var Wrapper$6 = styled.div(function(_ref94) {
  var theme = _ref94.theme, bordered = _ref94.bordered;
  return bordered ? { backgroundClip: "padding-box", border: "1px solid ".concat(theme.appBorderColor), borderRadius: theme.appBorderRadius, overflow: "hidden", boxSizing: "border-box" } : {};
}, function(_ref95) {
...
var Content = styled.div({ display: "block", position: "relative" }, function(_ref96) {
  ...
  var bordered = _ref97.bordered, theme = _ref97.theme;
  return bordered ? { borderRadius: "0 0 ".concat(theme.appBorderRadius - 1, "px ").concat(theme.appBorderRadius - 1, "px") } : {};
}, function(_ref98) {
...
var TabWrapper = function TabWrapper2(_ref101) {
  var active = _ref101.active, render = _ref101.render, children = _ref101.children;
  return import_react.default.createElement(VisuallyHidden, { active }, render ? render() : children);
};
var childrenToList = function childrenToList2(children, selected) {
  return import_react.Children.toArray(children).map(function(_ref102, index2) {
    var _ref102$props = _ref102.props, title = _ref102$props.title, id = _ref102$props.id, color = _ref102$props.color, childrenOfChild = _ref102$props.children;
    var content = Array.isArray(childrenOfChild) ? childrenOfChild[0] : childrenOfChild;
    return { active: selected ? id === selected : index2 === 0, title, id, color, render: typeof content === "function" ? content : function(_ref103) {
      var active = _ref103.active, key = _ref103.key;
      return import_react.default.createElement(VisuallyHidden, { key, active, role: "tabpanel" }, content);
    } };
  });
};
var Tabs = (0, import_react.memo)(function(_ref104) {
  ...
  return list.length ? import_react.default.createElement(Wrapper$6, { absolute, bordered, id: htmlId }, import_react.default.createElement(FlexBar, { border: true, backgroundColor }, import_react.default.createElement(TabBar, { role: "tablist" }, list.map(function(_ref105) {
    var title = _ref105.title, id = _ref105.id, active = _ref105.active, color = _ref105.color;
    var tabTitle = typeof title === "function" ? title() : title;
    return import_react.default.createElement(TabButton, { id: "tabbutton-".concat((0, import_csf.sanitize)(tabTitle)), className: "tabbutton ".concat(active ? "tabbutton-active" : ""), type: "button", key: id, active, textColor: color, onClick: function onClick(e2) {
      e2.preventDefault();
      actions.onSelect(id);
    }, role: "tab" }, tabTitle);
  })), tools ? import_react.default.createElement(import_react.Fragment, null, tools) : null), import_react.default.createElement(Content, { id: "panel-tab-content", bordered, absolute }, list.map(function(_ref106) {
    var id = _ref106.id, active = _ref106.active, render = _ref106.render;
    return render({ key: id, active });
  }))) : import_react.default.createElement(Placeholder, null, import_react.default.createElement(import_react.Fragment, { key: "title" }, "Nothing found"));
});
...
var TabsState = function(_Component2) {
  ...
  _createClass(TabsState2, [{ key: "render", value: function render() {
    ...
    return import_react.default.createElement(Tabs, { bordered, absolute, selected, backgroundColor, actions: this.handlers }, children);
  } }]);
  return TabsState2;
}(import_react.Component);
...
var Separator = styled.span(function(_ref107) {
  ...
  return { width: 1, height: 20, background: theme.appBorderColor, marginTop: 10, marginLeft: 6, marginRight: 2 };
}, function(_ref108) {
  var force = _ref108.force;
  return force ? {} : { "& + &": { display: "none" } };
});
Separator.displayName = "Separator";
var interleaveSeparators = function interleaveSeparators2(list) {
  return list.reduce(function(acc, item, index2) {
    return item ? import_react.default.createElement(import_react.Fragment, { key: item.id || item.key || "f-".concat(index2) }, acc, index2 > 0 ? import_react.default.createElement(Separator, { key: "s-".concat(index2) }) : null, item.render() || item) : acc;
  }, null);
};
...
var useUpdate = function useUpdate2(update, value2) {
  var previousValue = usePrevious(value2);
  return update ? value2 : previousValue;
};
var AddonPanel = function AddonPanel2(_ref109) {
  var active = _ref109.active, children = _ref109.children;
  return import_react.default.createElement("div", { hidden: !active, style: { transform: "translateX(0px)" } }, useUpdate(active, children));
};
var StorybookLogo = function StorybookLogo2(_a) {
  var alt = _a.alt, props = __rest(_a, ["alt"]);
  return import_react.default.createElement("svg", Object.assign({ width: "200px", height: "40px", viewBox: "0 0 200 40" }, props, { role: "img" }), alt ? import_react.default.createElement("title", null, alt) : null, import_react.default.createElement("defs", null, import_react.default.createElement("path", { d: "M1.2 36.9L0 3.9c0-1.1.8-2 1.9-2.1l28-1.8a2 2 0 0 1 2.2 1.9 2 2 0 0 1 0 .1v36a2 2 0 0 1-2 2 2 2 0 0 1-.1 0L3.2 38.8a2 2 0 0 1-2-2z", id: "a" })), import_react.default.createElement("g", { fill: "none", fillRule: "evenodd" }, import_react.default.createElement("path", { d: "M53.3 31.7c-1.7 0-3.4-.3-5-.7-1.5-.5-2.8-1.1-3.9-2l1.6-3.5c2.2 1.5 4.6 2.3 7.3 2.3 1.5 0 2.5-.2 3.3-.7.7-.5 1.1-1 1.1-1.9 0-.7-.3-1.3-1-1.7s-2-.8-3.7-1.2c-2-.4-3.6-.9-4.8-1.5-1.1-.5-2-1.2-2.6-2-.5-1-.8-2-.8-3.2 0-1.4.4-2.6 1.2-3.6.7-1.1 1.8-2 3.2-2.6 1.3-.6 2.9-.9 4.7-.9 1.6 0 3.1.3 4.6.7 1.5.5 2.7 1.1 3.5 2l-1.6 3.5c-2-1.5-4.2-2.3-6.5-2.3-1.3 0-2.3.2-3 .8-.8.5-1.2 1.1-1.2 2 0 .5.2 1 .5 1.3.2.3.7.6 1.4.9l2.9.8c2.9.6 5 1.4 6.2 2.4a5 5 0 0 1 2 4.2 6 6 0 0 1-2.5 5c-1.7 1.2-4 1.9-7 1.9zm21-3.6l1.4-.1-.2 3.5-1.9.1c-2.4 0-4.1-.5-5.2-1.5-1.1-1-1.6-2.7-1.6-4.8v-6h-3v-3.6h3V11h4.8v4.6h4v3.6h-4v6c0 1.8.9 2.8 2.6 2.8zm11.1 3.5c-1.6 0-3-.3-4.3-1a7 7 0 0 1-3-2.8c-.6-1.3-1-2.7-1-4.4 0-1.6.4-3 1-4.3a7 7 0 0 1 3-2.8c1.2-.7 2.7-1 4.3-1 1.7 0 3.2.3 4.4 1a7 7 0 0 1 3 2.8c.6 1.2 1 2.7 1 4.3 0 1.7-.4 3.1-1 4.4a7 7 0 0 1-3 2.8c-1.2.7-2.7 1-4.4 1zm0-3.6c2.4 0 3.6-1.6 3.6-4.6 0-1.5-.3-2.6-1-3.4a3.2 3.2 0 0 0-2.6-1c-2.3 0-3.5 1.4-3.5 4.4 0 3 1.2 4.6 3.5 4.6zm21.7-8.8l-2.7.3c-1.3.2-2.3.5-2.8 1.2-.6.6-.9 1.4-.9 2.5v8.2H96V15.7h4.6v2.6c.8-1.8 2.5-2.8 5-3h1.3l.3 4zm14-3.5h4.8L116.4 37h-4.9l3-6.6-6.4-14.8h5l4 10 4-10zm16-.4c1.4 0 2.6.3 3.6 1 1 .6 1.9 1.6 2.5 2.8.6 1.2.9 2.7.9 4.3 0 1.6-.3 3-1 4.3a6.9 6.9 0 0 1-2.4 2.9c-1 .7-2.2 1-3.6 1-1 0-2-.2-3-.7-.8-.4-1.5-1-2-1.9v2.4h-4.7V8.8h4.8v9c.5-.8 1.2-1.4 2-1.9.9-.4 1.8-.6 3-.6zM135.7 28c1.1 0 2-.4 2.6-1.2.6-.8 1-2 1-3.4 0-1.5-.4-2.5-1-3.3s-1.5-1.1-2.6-1.1-2 .3-2.6 1.1c-.6.8-1 2-1 3.3 0 1.5.4 2.6 1 3.4.6.8 1.5 1.2 2.6 1.2zm18.9 3.6c-1.7 0-3.2-.3-4.4-1a7 7 0 0 1-3-2.8c-.6-1.3-1-2.7-1-4.4 0-1.6.4-3 1-4.3a7 7 0 0 1 3-2.8c1.2-.7 2.7-1 4.4-1 1.6 0 3 .3 4.3 1a7 7 0 0 1 3 2.8c.6 1.2 1 2.7 1 4.3 0 1.7-.4 3.1-1 4.4a7 7 0 0 1-3 2.8c-1.2.7-2.7 1-4.3 1zm0-3.6c2.3 0 3.5-1.6 3.5-4.6 0-1.5-.3-2.6-1-3.4a3.2 3.2 0 0 0-2.5-1c-2.4 0-3.6 1.4-3.6 4.4 0 3 1.2 4.6 3.6 4.6zm18 3.6c-1.7 0-3.2-.3-4.4-1a7 7 0 0 1-3-2.8c-.6-1.3-1-2.7-1-4.4 0-1.6.4-3 1-4.3a7 7 0 0 1 3-2.8c1.2-.7 2.7-1 4.4-1 1.6 0 3 .3 4.4 1a7 7 0 0 1 2.9 2.8c.6 1.2 1 2.7 1 4.3 0 1.7-.4 3.1-1 4.4a7 7 0 0 1-3 2.8c-1.2.7-2.7 1-4.3 1zm0-3.6c2.3 0 3.5-1.6 3.5-4.6 0-1.5-.3-2.6-1-3.4a3.2 3.2 0 0 0-2.5-1c-2.4 0-3.6 1.4-3.6 4.4 0 3 1.2 4.6 3.6 4.6zm27.4 3.4h-6l-6-7v7h-4.8V8.8h4.9v13.6l5.8-6.7h5.7l-6.6 7.5 7 8.2z", fill: "currentColor" }), import_react.default.createElement("mask", { id: "b", fill: "#fff" }, import_react.default.createElement("use", { xlinkHref: "#a" })), import_react.default.createElement("use", { fill: "#FF4785", fillRule: "nonzero", xlinkHref: "#a" }), import_react.default.createElement("path", { d: "M23.7 5L24 .2l3.9-.3.1 4.8a.3.3 0 0 1-.5.2L26 3.8l-1.7 1.4a.3.3 0 0 1-.5-.3zm-5 10c0 .9 5.3.5 6 0 0-5.4-2.8-8.2-8-8.2-5.3 0-8.2 2.8-8.2 7.1 0 7.4 10 7.6 10 11.6 0 1.2-.5 1.9-1.8 1.9-1.6 0-2.2-.9-2.1-3.6 0-.6-6.1-.8-6.3 0-.5 6.7 3.7 8.6 8.5 8.6 4.6 0 8.3-2.5 8.3-7 0-7.9-10.2-7.7-10.2-11.6 0-1.6 1.2-1.8 2-1.8.6 0 2 0 1.9 3z", fill: "#FFF", fillRule: "nonzero", mask: "url(#b)" })));
};
var StorybookIcon = function StorybookIcon2(_a) {
  var props = __rest(_a, []);
  return import_react.default.createElement("svg", Object.assign({ viewBox: "0 0 64 64" }, props), import_react.default.createElement("title", null, "Storybook icon"), import_react.default.createElement("g", { id: "Artboard", stroke: "none", strokeWidth: "1", fill: "none", fillRule: "evenodd" }, import_react.default.createElement("path", { d: "M8.04798541,58.7875918 L6.07908839,6.32540407 C6.01406344,4.5927838 7.34257463,3.12440831 9.07303814,3.01625434 L53.6958037,0.227331489 C55.457209,0.117243658 56.974354,1.45590096 57.0844418,3.21730626 C57.0885895,3.28366922 57.0906648,3.35014546 57.0906648,3.41663791 L57.0906648,60.5834697 C57.0906648,62.3483119 55.6599776,63.7789992 53.8951354,63.7789992 C53.847325,63.7789992 53.7995207,63.7779262 53.7517585,63.775781 L11.0978899,61.8600599 C9.43669044,61.7854501 8.11034889,60.4492961 8.04798541,58.7875918 Z", id: "path-1", fill: "#FF4785", fillRule: "nonzero" }), import_react.default.createElement("path", { d: "M35.9095005,24.1768792 C35.9095005,25.420127 44.2838488,24.8242707 45.4080313,23.9509748 C45.4080313,15.4847538 40.8652557,11.0358878 32.5466666,11.0358878 C24.2280775,11.0358878 19.5673077,15.553972 19.5673077,22.3311017 C19.5673077,34.1346028 35.4965208,34.3605071 35.4965208,40.7987804 C35.4965208,42.606015 34.6115646,43.6790606 32.6646607,43.6790606 C30.127786,43.6790606 29.1248356,42.3834613 29.2428298,37.9783269 C29.2428298,37.0226907 19.5673077,36.7247626 19.2723223,37.9783269 C18.5211693,48.6535354 25.1720308,51.7326752 32.7826549,51.7326752 C40.1572906,51.7326752 45.939005,47.8018145 45.939005,40.6858282 C45.939005,28.035186 29.7738035,28.3740425 29.7738035,22.1051974 C29.7738035,19.5637737 31.6617103,19.2249173 32.7826549,19.2249173 C33.9625966,19.2249173 36.0864917,19.4328883 35.9095005,24.1768792 Z", id: "path9_fill-path", fill: "#FFFFFF", fillRule: "nonzero" }), import_react.default.createElement("path", { d: "M44.0461638,0.830433986 L50.1874092,0.446606143 L50.443532,7.7810017 C50.4527198,8.04410717 50.2468789,8.26484453 49.9837734,8.27403237 C49.871115,8.27796649 49.7607078,8.24184808 49.6721567,8.17209069 L47.3089847,6.3104681 L44.5110468,8.43287463 C44.3012992,8.591981 44.0022839,8.55092814 43.8431776,8.34118051 C43.7762017,8.25288717 43.742082,8.14401677 43.7466857,8.03329059 L44.0461638,0.830433986 Z", id: "Path", fill: "#FFFFFF" })));
};
function e() {
...
var o = ["allowFullScreen", "allowTransparency", "autoComplete", "autoFocus", "autoPlay", "cellPadding", "cellSpacing", "charSet", "className", "classId", "colSpan", "contentEditable", "contextMenu", "crossOrigin", "encType", "formAction", "formEncType", "formMethod", "formNoValidate", "formTarget", "frameBorder", "hrefLang", "inputMode", "keyParams", "keyType", "marginHeight", "marginWidth", "maxLength", "mediaGroup", "minLength", "noValidate", "radioGroup", "readOnly", "rowSpan", "spellCheck", "srcDoc", "srcLang", "srcSet", "tabIndex", "useMap"].reduce(function(t, e2) {
  return t[e2.toLowerCase()] = e2, t;
}, { for: "htmlFor" });
var c = { amp: "&", apos: "'", gt: ">", lt: "<", nbsp: "\xA0", quot: "\u201C" };
var a2 = ["style", "script"];
...
var K = /^~~((?:\[.*?\]|<.*?>(?:.*?<.*?>)?|`.*?`|.)*?)~~/;
var Y = /^\\([^0-9A-Za-z\s])/;
var tt2 = /^[\s\S]+?(?=[^0-9A-Z\s\u00c0-\uffff&;.()'"]|\d+\.|\n\n| {2,}\n|\w+:\S|$)/i;
var et = /^\n+/;
var nt = /^([ \t]*)/;
var rt = /\\([^0-9A-Z\s])/gi;
var ot = new RegExp("^( *)((?:[*+-]|\\d+\\.)) +");
var ct = new RegExp("^( *)((?:[*+-]|\\d+\\.)) +[^\\n]*(?:\\n(?!\\1(?:[*+-]|\\d+\\.) )[^\\n]*)*(\\n|$)", "gm");
var at = new RegExp("^( *)((?:[*+-]|\\d+\\.)) [\\s\\S]+?(?:\\n{2,}(?! )(?!\\1(?:[*+-]|\\d+\\.) (?!(?:[*+-]|\\d+\\.) ))\\n*|\\s*\\n*$)");
var ut = "(?:\\[[^\\]]*\\]|[^\\[\\]]|\\](?=[^\\[]*\\]))*";
var it = new RegExp("^\\[(" + ut + `)\\]\\(\\s*<?((?:[^\\s\\\\]|\\\\.)*?)>?(?:\\s+['"]([\\s\\S]*?)['"])?\\s*\\)`);
var lt = new RegExp("^!\\[(" + ut + `)\\]\\(\\s*<?((?:[^\\s\\\\]|\\\\.)*?)>?(?:\\s+['"]([\\s\\S]*?)['"])?\\s*\\)`);
var st = [s, g, p2, S, $6, E, ct, at, C];
var _t = [].concat(st, [/^[^\n]+(?:  \n|\n{2,})/, w, R]);
function ft(t) {
...
function pt(t, e2, n2) {
  ...
  return o2.forEach(function(t2, e3) {
    "tableSeparator" === t2.type ? 0 !== e3 && e3 !== o2.length - 1 && c2.push([]) : ("text" !== t2.type || null != o2[e3 + 1] && "tableSeparator" !== o2[e3 + 1].type || (t2.content = t2.content.replace(U, "")), c2[c2.length - 1].push(t2));
  }), c2;
}
function gt(t, e2, n2) {
  n2.o = true;
  var r2 = pt(t[1], e2, n2), o2 = t[2].replace(q, "").split("|").map(dt), c2 = function(t2, e3, n3) {
...
var Et = function Et2(t, e2, n2) {
  return { content: $t(e2, t[1], n2) };
};
function At() {
  return {};
}
...
function Bt(r2) {
  ...
  var U2 = q2.createElement || import_react.default.createElement;
  function V2(t, n2) {
    var o2 = Mt(q2.overrides, "".concat(t, ".props"), {});
    for (var _len4 = arguments.length, r3 = new Array(_len4 > 2 ? _len4 - 2 : 0), _key4 = 2; _key4 < _len4; _key4++) {
      r3[_key4 - 2] = arguments[_key4];
    }
    return U2.apply(void 0, [function(t2, e2) {
      var n3 = Mt(e2, t2);
      return n3 ? "function" == typeof n3 || "object" == _typeof(n3) && "render" in n3 ? n3 : Mt(e2, "".concat(t2, ".component"), t2) : t2;
    }(t, q2.overrides), e({}, n2, o2, { className: It(null == n2 ? void 0 : n2.className, o2.className) || void 0 })].concat(r3));
  }
  function W2(e2) {
    var n2 = false;
    q2.forceInline ? n2 = true : q2.forceBlock || (n2 = false === P.test(e2));
    ...
    if (r3.length > 1 || q2.forceWrapper)
      ...
      if (1 === r3.length)
        return c2 = r3[0], "string" == typeof c2 ? V2("span", { key: "outer" }, c2) : c2;
      c2 = null;
    }
    return import_react.default.createElement(o2, { key: "outer" }, c2);
  }
  function Q2(e2) {
    var r3 = e2.match(u);
    return r3 ? r3.reduce(function(e3, r4, c2) {
      ...
      if (-1 !== a3) {
        var _u = function(t) {
          return -1 !== t.indexOf("-") && null === t.match(A) && (t = t.replace(j, function(t2, e4) {
            return e4.toUpperCase();
          })), t;
        }(r4.slice(0, a3)).trim(), _i2 = function(t) {
          return t ? (n.test(t.charAt(0)) && (t = t.substr(1)), n.test(t.charAt(t.length - 1)) && (t = t.substr(0, t.length - 1)), t) : "";
        }(r4.slice(a3 + 1).trim()), _l = o[_u] || _u, _s2 = e3[_l] = function(t, e4) {
          return "style" === t ? e4.split(/;\s?/).reduce(function(t2, e5) {
            var n2 = e5.slice(0, e5.indexOf(":"));
            return t2[n2.replace(/(-[a-z])/g, function(t3) {
              return t3[1].toUpperCase();
            })] = e5.slice(n2.length + 1).trim(), t2;
          }, {}) : "href" === t ? bt(e4) : (e4.match(I) && (e4 = e4.slice(1, e4.length - 1)), "true" === e4 || "false" !== e4 && e4);
        }(_u, _i2);
        "string" == typeof _s2 && (w.test(_s2) || R.test(_s2)) && (e3[_l] = import_react.default.cloneElement(W2(_s2.trim()), { key: c2 }));
      } else
        "style" !== r4 && (e3[o[r4] || r4] = true);
      return e3;
    }, {}) : void 0;
  }
  var rt2 = [], ut2 = {}, st2 = { blockQuote: { i: kt(s), l: Ot.HIGH, _: function _(t, e2, n2) {
    return { content: e2(t[0].replace(_2, ""), n2) };
  }, p: function p3(t, e2, n2) {
    return V2("blockquote", { key: n2.g }, e2(t.content, n2));
  } }, breakLine: { i: xt(f), l: Ot.HIGH, _: At, p: function p3(t, e2, n2) {
    return V2("br", { key: n2.g });
  } }, breakThematic: { i: kt(d), l: Ot.HIGH, _: At, p: function p3(t, e2, n2) {
    return V2("hr", { key: n2.g });
  } }, codeBlock: { i: kt(g), l: Ot.MAX, _: function _(t) {
    return { content: t[0].replace(/^ {4}/gm, "").replace(/\n+$/, ""), lang: void 0 };
  }, p: function p3(t, e2, n2) {
    return V2("pre", { key: n2.g }, V2("code", { className: t.lang ? "lang-".concat(t.lang) : "" }, t.content));
  } }, codeFenced: { i: kt(p2), l: Ot.MAX, _: function _(t) {
    return { content: t[3], lang: t[2] || void 0, type: "codeBlock" };
  } }, codeInline: { i: ht(m), l: Ot.LOW, _: function _(t) {
    return { content: t[2] };
  }, p: function p3(t, e2, n2) {
    return V2("code", { key: n2.g }, t.content);
  } }, footnote: { i: kt(k), l: Ot.MAX, _: function _(t) {
    return rt2.push({ footnote: t[2], identifier: t[1] }), {};
  }, p: Rt }, footnoteReference: { i: yt(x), l: Ot.HIGH, _: function _(t) {
    return { content: t[1], target: "#".concat(q2.slugify(t[1])) };
  }, p: function p3(t, e2, n2) {
    return V2("a", { key: n2.g, href: bt(t.target) }, V2("sup", { key: n2.g }, t.content));
  } }, gfmTask: { i: yt(b), l: Ot.HIGH, _: function _(t) {
    return { completed: "x" === t[1].toLowerCase() };
  }, p: function p3(t, e2, n2) {
    return V2("input", { checked: t.completed, key: n2.g, readOnly: true, type: "checkbox" });
  } }, heading: { i: kt(S), l: Ot.HIGH, _: function _(t, e2, n2) {
    return { content: $t(e2, t[2], n2), id: q2.slugify(t[2]), level: t[1].length };
  }, p: function p3(t, e2, n2) {
    return t.tag = "h".concat(t.level), V2(t.tag, { id: t.id, key: n2.g }, e2(t.content, n2));
  } }, headingSetext: { i: kt($6), l: Ot.MAX, _: function _(t, e2, n2) {
    return { content: $t(e2, t[1], n2), level: "=" === t[2] ? 1 : 2, type: "heading" };
  } }, htmlComment: { i: xt(E), l: Ot.HIGH, _: function _() {
    return {};
  }, p: Rt }, image: { i: ht(lt), l: Ot.HIGH, _: function _(t) {
    return { alt: t[1], target: St(t[2]), title: t[3] };
  }, p: function p3(t, e2, n2) {
    return V2("img", { key: n2.g, alt: t.alt || void 0, title: t.title || void 0, src: bt(t.target) });
  } }, link: { i: yt(it), l: Ot.LOW, _: function _(t, e2, n2) {
    return { content: wt(e2, t[1], n2), target: St(t[2]), title: t[3] };
  }, p: function p3(t, e2, n2) {
    return V2("a", { key: n2.g, href: bt(t.target), title: t.title }, e2(t.content, n2));
  } }, linkAngleBraceStyleDetector: { i: yt(B), l: Ot.MAX, _: function _(t) {
    return { content: [{ content: t[1], type: "text" }], target: t[1], type: "link" };
  } }, linkBareUrlDetector: { i: function i2(t, e2) {
    return e2.m ? null : yt(M)(t, e2);
  }, l: Ot.MAX, _: function _(t) {
    return { content: [{ content: t[1], type: "text" }], target: t[1], title: void 0, type: "link" };
  } }, linkMailtoDetector: { i: yt(O), l: Ot.MAX, _: function _(t) {
    var e2 = t[1], n2 = t[1];
    return i.test(n2) || (n2 = "mailto:" + n2), { content: [{ content: e2.replace("mailto:", ""), type: "text" }], target: n2, type: "link" };
  } }, list: { i: function i2(t, e2, n2) {
    var r3 = T.exec(n2);
    return !r3 || !e2.h && e2.o ? null : at.exec(t = r3[1] + t);
  }, l: Ot.HIGH, _: function _(t, e2, n2) {
    var r3 = t[2], o2 = r3.length > 1, c2 = o2 ? +r3 : void 0, a3 = t[0].replace(l, "\n").match(ct);
    var u2 = false;
    return { items: a3.map(function(t2, r4) {
      var o3 = ot.exec(t2)[0].length, c3 = new RegExp("^ {1," + o3 + "}", "gm"), i2 = t2.replace(c3, "").replace(ot, ""), l2 = r4 === a3.length - 1, s2 = -1 !== i2.indexOf("\n\n") || l2 && u2;
      u2 = s2;
      var _3 = n2.o, f2 = n2.h;
      var d2;
    ...
    return V2(t.ordered ? "ol" : "ul", { key: n2.g, start: t.start }, t.items.map(function(t2, r3) {
      return V2("li", { key: r3 }, e2(t2, n2));
    }));
  } }, newlineCoalescer: { i: kt(y), l: Ot.LOW, _: At, p: function p3() {
    return "\n";
  } }, paragraph: { i: vt, l: Ot.LOW, _: Et, p: function p3(t, e2, n2) {
    return V2("p", { key: n2.g }, e2(t.content, n2));
  } }, ref: { i: yt(D), l: Ot.MAX, _: function _(t) {
    return ut2[t[1]] = { target: t[2], title: t[4] }, {};
  }, p: Rt }, refImage: { i: ht(N), l: Ot.MAX, _: function _(t) {
    return { alt: t[1] || void 0, ref: t[2] };
  }, p: function p3(t, e2, n2) {
    return V2("img", { key: n2.g, alt: t.alt, src: bt(ut2[t.ref].target), title: ut2[t.ref].title });
  } }, refLink: { i: yt(Z), l: Ot.MAX, _: function _(t, e2, n2) {
    return { content: e2(t[1], n2), fallbackContent: e2(t[0].replace(F, "\\$1"), n2), ref: t[2] };
  }, p: function p3(t, e2, n2) {
    return ut2[t.ref] ? V2("a", { key: n2.g, href: bt(ut2[t.ref].target), title: ut2[t.ref].title }, e2(t.content, n2)) : V2("span", { key: n2.g }, e2(t.fallbackContent, n2));
  } }, table: { i: kt(C), l: Ot.HIGH, _: gt, p: function p3(t, e2, n2) {
    return V2("table", { key: n2.g }, V2("thead", null, V2("tr", null, t.header.map(function(r3, o2) {
      return V2("th", { key: o2, style: mt(t, o2) }, e2(r3, n2));
    }))), V2("tbody", null, t.cells.map(function(r3, o2) {
      return V2("tr", { key: o2 }, r3.map(function(r4, o3) {
        return V2("td", { key: o3, style: mt(t, o3) }, e2(r4, n2));
      }));
    })));
  } }, tableSeparator: { i: function i2(t, e2) {
    return e2.t ? H.exec(t) : null;
  }, l: Ot.HIGH, _: function _() {
    return { type: "tableSeparator" };
  }, p: function p3() {
    return " | ";
  } }, text: { i: xt(tt2), l: Ot.MIN, _: function _(t) {
    return { content: t[0].replace(z, function(t2, e2) {
      return q2.namedCodesToUnicode[e2] ? q2.namedCodesToUnicode[e2] : t2;
    }) };
  }, p: function p3(t) {
    return t.content;
  } }, textBolded: { i: ht(X), l: Ot.MED, _: function _(t, e2, n2) {
    return { content: e2(t[2], n2) };
  }, p: function p3(t, e2, n2) {
    return V2("strong", { key: n2.g }, e2(t.content, n2));
  } }, textEmphasized: { i: ht(J), l: Ot.LOW, _: function _(t, e2, n2) {
    return { content: e2(t[2], n2) };
  }, p: function p3(t, e2, n2) {
    return V2("em", { key: n2.g }, e2(t.content, n2));
  } }, textEscaped: { i: ht(Y), l: Ot.HIGH, _: function _(t) {
    return { content: t[1], type: "text" };
  } }, textStrikethroughed: { i: ht(K), l: Ot.LOW, _: Et, p: function p3(t, e2, n2) {
    return V2("del", { key: n2.g }, e2(t.content, n2));
  } } };
  true !== q2.disableParsingRawHTML && (st2.htmlBlock = { i: xt(w), l: Ot.HIGH, _: function _(t, e2, n2) {
    var _t$3$match = t[3].match(nt), _t$3$match2 = _slicedToArray(_t$3$match, 2), r3 = _t$3$match2[1], o2 = new RegExp("^".concat(r3), "gm"), c2 = t[3].replace(o2, ""), u2 = (i2 = c2, _t.some(function(t2) {
      return t2.test(i2);
    }) ? zt : $t);
    var i2;
    var l2 = t[1].toLowerCase(), s2 = -1 !== a2.indexOf(l2);
    n2.m = n2.m || "a" === l2;
    var _3 = s2 ? t[3] : u2(e2, c2, n2);
    return n2.m = false, { attrs: Q2(t[2]), content: _3, noInnerParse: s2, tag: s2 ? l2 : t[1] };
  }, p: function p3(t, n2, r3) {
    return V2(t.tag, e({ key: r3.g }, t.attrs), t.noInnerParse ? t.content : n2(t.content, r3));
  } }, st2.htmlSelfClosing = { i: xt(R), l: Ot.HIGH, _: function _(t) {
    return { attrs: Q2(t[2] || ""), tag: t[1] };
  }, p: function p3(t, n2, r3) {
    return V2(t.tag, e({}, t.attrs, { key: r3.g }));
  } });
  var dt2 = function(t) {
    var e2 = Object.keys(t);
    function n2(r3, o2) {
      var c2 = [], a3 = "";
      for (; r3; ) {
        var _u2 = 0;
        for (; _u2 < e2.length; ) {
          var _i3 = e2[_u2], _l2 = t[_i3], _s3 = _l2.i(r3, o2, a3);
          if (_s3) {
            var _t2 = _s3[0];
            r3 = r3.substring(_t2.length);
            var _e2 = _l2._(_s3, n2, o2);
            null == _e2.type && (_e2.type = _i3), c2.push(_e2), a3 = _t2;
            break;
          }
          _u2++;
        }
  ...
  }(st2), pt2 = (Bt2 = function(t) {
    return function(e2, n2, r3) {
      return t[e2.type].p(e2, n2, r3);
    };
  }(st2), function t(e2) {
    ...
    if (Array.isArray(e2)) {
      ...
      for (var _r2 = 0; _r2 < e2.length; _r2++) {
        n2.g = _r2;
        var _a2 = t(e2[_r2], n2), _u3 = "string" == typeof _a2;
  ...
  var Bt2;
  var Lt = W2(r2);
  return rt2.length ? V2("div", null, Lt, V2("footer", { key: "footer" }, rt2.map(function(t) {
    return V2("div", { id: q2.slugify(t.identifier), key: t.identifier }, t.identifier, pt2(dt2(t.footnote, { o: true })));
  }))) : Lt;
}
!function(t) {
...
var Markdown = function Markdown2(e2) {
  var n2 = e2.children, o2 = e2.options, c2 = function(t, e3) {
    if (null == t)
      return {};
    var n3, r2, o3 = {}, c3 = Object.keys(t);
    for (r2 = 0; r2 < c3.length; r2++) {
      e3.indexOf(n3 = c3[r2]) >= 0 || (o3[n3] = t[n3]);
    }
    return o3;
  }(e2, r);
  return import_react.default.cloneElement(Bt(n2, o2), c2);
};
var Description$1 = function Description$12(_ref110) {
  var markdown = _ref110.markdown;
  return import_react.default.createElement(ResetWrapper, null, import_react.default.createElement(Markdown, { options: { forceBlock: true, overrides: components$1 } }, markdown));
};
var breakpoint = 600;
var Title = styled.h1(withReset, function(_ref111) {
  var theme = _ref111.theme;
  return _defineProperty2({ color: theme.color.defaultText, fontSize: theme.typography.size.m3, fontWeight: theme.typography.weight.black, lineHeight: "32px" }, "@media (min-width: ".concat(breakpoint, "px)"), { fontSize: theme.typography.size.l1, lineHeight: "36px", marginBottom: ".5rem" });
});
var Subtitle = styled.h2(withReset, function(_ref113) {
  var _ref114;
  var theme = _ref113.theme;
  return _ref114 = { fontWeight: theme.typography.weight.regular, fontSize: theme.typography.size.s3, lineHeight: "20px", borderBottom: "none", marginBottom: 15 }, _defineProperty2(_ref114, "@media (min-width: ".concat(breakpoint, "px)"), { fontSize: theme.typography.size.m1, lineHeight: "28px", marginBottom: 24 }), _defineProperty2(_ref114, "color", curriedTransparentize$1(0.25, theme.color.defaultText)), _ref114;
});
var DocsContent = styled.div({ maxWidth: 1e3, width: "100%" });
var DocsWrapper = styled.div(function(_ref115) {
  var theme = _ref115.theme;
  return _defineProperty2({ background: theme.background.content, display: "flex", justifyContent: "center", padding: "4rem 20px", minHeight: "100vh", boxSizing: "border-box" }, "@media (min-width: ".concat(breakpoint, "px)"), {});
});
var DocsPageWrapper = function DocsPageWrapper2(_ref117) {
  var children = _ref117.children;
  return import_react.default.createElement(DocsWrapper, null, import_react.default.createElement(DocsContent, null, children));
};
var getBlockBackgroundStyle = function getBlockBackgroundStyle2(theme) {
  return { borderRadius: theme.appBorderRadius, background: theme.background.content, boxShadow: theme.base === "light" ? "rgba(0, 0, 0, 0.10) 0 1px 3px 0" : "rgba(0, 0, 0, 0.20) 0 2px 5px 0", border: "1px solid ".concat(theme.appBorderColor) };
};
var getStoryHref = function getStoryHref2(baseUrl, storyId) {
  ...
  var _baseUrl$split = baseUrl.split("?"), _baseUrl$split2 = _slicedToArray(_baseUrl$split, 2), url = _baseUrl$split2[0], paramsStr = _baseUrl$split2[1];
  var params = paramsStr ? Object.assign(Object.assign(Object.assign({}, import_qs.default.parse(paramsStr)), additionalParams), { id: storyId }) : Object.assign(Object.assign({}, additionalParams), { id: storyId });
  return "".concat(url).concat(import_qs.default.stringify(params, { addQueryPrefix: true, encode: false }));
};
var Zoom = function Zoom2(_ref118) {
  var zoom = _ref118.zoom, resetZoom = _ref118.resetZoom;
  return import_react.default.createElement(import_react.default.Fragment, null, import_react.default.createElement(IconButton, { key: "zoomin", onClick: function onClick(e2) {
    e2.preventDefault();
    zoom(0.8);
  }, title: "Zoom in" }, import_react.default.createElement(Icons, { icon: "zoom" })), import_react.default.createElement(IconButton, { key: "zoomout", onClick: function onClick(e2) {
    e2.preventDefault();
    zoom(1.25);
  }, title: "Zoom out" }, import_react.default.createElement(Icons, { icon: "zoomout" })), import_react.default.createElement(IconButton, { key: "zoomreset", onClick: function onClick(e2) {
    e2.preventDefault();
    resetZoom();
...
var Eject = function Eject2(_ref119) {
  ...
  return import_react.default.createElement(IconButton, { key: "opener", href: getStoryHref(baseUrl, storyId), target: "_blank", title: "Open canvas in new tab" }, import_react.default.createElement(Icons, { icon: "share" }));
};
...
var Toolbar = function Toolbar2(_a) {
  ...
  return import_react.default.createElement(Bar, Object.assign({}, rest), import_react.default.createElement(import_react.Fragment, { key: "left" }, isLoading ? [1, 2, 3].map(function(key) {
    return import_react.default.createElement(IconButtonSkeleton, { key });
  }) : import_react.default.createElement(Zoom, Object.assign({}, { zoom, resetZoom }))), import_react.default.createElement(import_react.Fragment, { key: "right" }, storyId && (isLoading ? import_react.default.createElement(IconButtonSkeleton, null) : import_react.default.createElement(Eject, Object.assign({}, { storyId, baseUrl })))));
};
var ZoomContext = (0, import_react.createContext)({ scale: 1 });
var globalWindow$1 = window_1.window;
var IFrame = function(_Component3) {
  ...
  _createClass(IFrame2, [{ key: "componentDidMount", value: function componentDidMount() {
    ...
    var _a = this.props, id = _a.id, title = _a.title, src = _a.src, allowFullScreen = _a.allowFullScreen, scale = _a.scale, rest = __rest(_a, ["id", "title", "src", "allowFullScreen", "scale"]);
    return import_react.default.createElement("iframe", Object.assign({
      id,
      title,
      src,
      allowFullScreen,
...
var EventSource = window_1.EventSource;
var CONFIG_TYPE = window_1.CONFIG_TYPE;
...
var ProgressTrack = styled.div(function(_ref121) {
  ...
  return { position: "relative", width: "80%", marginBottom: "0.75rem", maxWidth: 300, height: 5, borderRadius: 5, background: curriedTransparentize$1(0.8, theme.color.secondary), overflow: "hidden", cursor: "progress" };
});
var ProgressBar = styled.div(function(_ref122) {
  var theme = _ref122.theme;
  return { position: "absolute", top: 0, left: 0, height: "100%", background: theme.color.secondary };
});
...
var ErrorIcon = styled(Icons)(function(_ref124) {
  ...
  return { width: 20, height: 20, marginBottom: "0.5rem", color: theme.color.mediumdark };
});
var ellipsis = keyframes(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(['\n  from { content: "..." }\n  33% { content: "." }\n  66% { content: ".." }\n  to { content: "..." }\n'])));
...
var PureLoader = function PureLoader2(_a) {
  ...
  if (error2) {
    return import_react.default.createElement(ProgressWrapper, Object.assign({ "aria-label": error2.toString(), "aria-live": "polite", role: "status" }, props), import_react.default.createElement(ErrorIcon, { icon: "lightningoff" }), import_react.default.createElement(ProgressMessage, null, error2.message));
  }
  if (progress) {
    ...
    return import_react.default.createElement(ProgressWrapper, Object.assign({ "aria-label": "Content is loading...", "aria-live": "polite", "aria-valuemin": 0, "aria-valuemax": 100, "aria-valuenow": _value * 100, "aria-valuetext": message, role: "progressbar" }, props), import_react.default.createElement(ProgressTrack, null, import_react.default.createElement(ProgressBar, { style: { width: "".concat(_value * 100, "%") } })), import_react.default.createElement(ProgressMessage, null, message, _value < 1 && import_react.default.createElement(Ellipsis, { key: message })));
  }
  return import_react.default.createElement(LoaderWrapper, Object.assign({ "aria-label": "Content is loading...", "aria-live": "polite", role: "status", size }, props));
};
var Loader = function Loader2(props) {
  var _useState3 = (0, import_react.useState)(void 0), _useState4 = _slicedToArray(_useState3, 2), progress = _useState4[0], setProgress = _useState4[1];
  var _useState5 = (0, import_react.useState)(void 0), _useState6 = _slicedToArray(_useState5, 2), error2 = _useState6[0], setError = _useState6[1];
  (0, import_react.useEffect)(function() {
  ...
  return import_react.default.createElement(PureLoader, Object.assign({ progress, error: error2 }, props));
};
...
var InlineStory = function InlineStory2(_ref125) {
  ...
  return import_react.default.createElement(import_react.Fragment, null, height ? import_react.default.createElement("style", null, "#story--".concat(id, " { min-height: ").concat(height, "; transform: translateZ(0); overflow: auto }")) : null, import_react.default.createElement(import_react.Fragment, null, storyFn ? (0, import_react.createElement)(storyFn) : import_react.default.createElement(EmptyBlock, null, MISSING_STORY(id))));
};
var IFrameStory = function IFrameStory2(_ref126) {
  ...
  return import_react.default.createElement("div", { style: { width: "100%", height } }, import_react.default.createElement(ZoomContext.Consumer, null, function(_ref127) {
    var scale = _ref127.scale;
    return import_react.default.createElement(IFrame, { key: "iframe", id: "iframe--".concat(id), title, src: getStoryHref(BASE_URL, id, { viewMode: "story" }), allowFullScreen: true, scale, style: { width: "100%", height: "100%", border: "0 none" } });
  }));
};
var Story = function Story2(_a) {
  var children = _a.children, error2 = _a.error, inline = _a.inline, props = __rest(_a, ["children", "error", "inline"]);
  var id = props.id, title = props.title, height = props.height;
  if (error2) {
    return import_react.default.createElement(EmptyBlock, null, error2);
  }
  return inline ? import_react.default.createElement(InlineStory, Object.assign({}, props)) : import_react.default.createElement(IFrameStory, { id, title, height });
};
var StorySkeleton = function StorySkeleton2() {
  return import_react.default.createElement(Loader, null);
};
...
var StyledSource = styled(Source)(function(_ref132) {
...
var PreviewContainer = styled.div(function(_ref133) {
  var theme = _ref133.theme, withSource = _ref133.withSource, isExpanded = _ref133.isExpanded;
  return Object.assign(Object.assign({ position: "relative", overflow: "hidden", margin: "25px 0 40px" }, getBlockBackgroundStyle(theme)), { borderBottomLeftRadius: withSource && isExpanded && 0, borderBottomRightRadius: withSource && isExpanded && 0, borderBottomWidth: isExpanded && 0 });
}, function(_ref134) {
...
var getSource = function getSource2(withSource, expanded, setExpanded) {
  switch (true) {
    ...
    case expanded: {
      return { source: import_react.default.createElement(StyledSource, Object.assign({}, withSource, { dark: true })), actionItem: { title: "Hide code", className: "docblock-code-toggle docblock-code-toggle--expanded", onClick: function onClick() {
        return setExpanded(false);
      } } };
    }
    default: {
      return { source: import_react.default.createElement(StyledSource, Object.assign({}, withSource, { dark: true })), actionItem: { title: "Show code", className: "docblock-code-toggle", onClick: function onClick() {
...
var Preview = function Preview2(_a) {
  ...
  var _useState7 = (0, import_react.useState)(isExpanded), _useState8 = _slicedToArray(_useState7, 2), expanded = _useState8[0], setExpanded = _useState8[1];
  var _getSource = getSource(withSource, expanded, setExpanded), source = _getSource.source, actionItem = _getSource.actionItem;
  var _useState9 = (0, import_react.useState)(1), _useState10 = _slicedToArray(_useState9, 2), scale = _useState10[0], setScale = _useState10[1];
  var previewClasses = [className].concat(["sbdocs", "sbdocs-preview"]);
  var defaultActionItems = withSource ? [actionItem] : [];
  var _useState11 = (0, import_react.useState)(additionalActions ? _toConsumableArray(additionalActions) : []), _useState12 = _slicedToArray(_useState11, 2), additionalActionItems = _useState12[0], setAdditionalActionItems = _useState12[1];
  var actionItems = [].concat(defaultActionItems, _toConsumableArray(additionalActionItems));
  var layout = getLayout(import_react.Children.count(children) === 1 ? [children] : children);
  var globalWindow2 = window_1.window;
  var copyToClipboard = (0, import_react.useCallback)(function(text) {
    return __awaiter(void 0, void 0, void 0, regeneratorRuntime.mark(function _callee2() {
  ...
  var onCopyCapture = function onCopyCapture2(e2) {
    ...
    if (additionalActionItems.filter(function(item) {
      ...
      copyToClipboard(source.props.code).then(function() {
        setAdditionalActionItems([].concat(_toConsumableArray(additionalActionItems), [{ title: "Copied", onClick: function onClick() {
        } }]));
  ...
  return import_react.default.createElement(PreviewContainer, Object.assign({}, { withSource, withToolbar }, props, { className: previewClasses.join(" ") }), withToolbar && import_react.default.createElement(PositionedToolbar, { isLoading, border: true, zoom: function zoom(z2) {
    return setScale(scale * z2);
  }, resetZoom: function resetZoom() {
    return setScale(1);
  }, storyId: getStoryId(children), baseUrl: "./iframe.html" }), import_react.default.createElement(ZoomContext.Provider, { value: { scale } }, import_react.default.createElement(Relative, { className: "docs-story", onCopyCapture: withSource && onCopyCapture }, import_react.default.createElement(ChildrenContainer, { isColumn: isColumn || !Array.isArray(children), columns, layout }, import_react.default.createElement(Zoom$1.Element, { scale }, Array.isArray(children) ? children.map(function(child, i2) {
    return import_react.default.createElement("div", { key: i2 }, child);
  }) : import_react.default.createElement("div", null, children))), import_react.default.createElement(ActionBar, { actionItems }))), withSource && expanded && source);
};
...
var PreviewSkeleton = function PreviewSkeleton2() {
  return import_react.default.createElement(StyledPreview, { isLoading: true, withToolbar: true }, import_react.default.createElement(StorySkeleton, null));
};
...
function equalByTag$1(object2, other, tag, bitmask, customizer, equalFunc, stack) {
  switch (tag) {
    ...
    case setTag$5:
      ...
      var result2 = equalArrays$1(convert2(object2), convert2(other), bitmask, customizer, equalFunc, stack);
...
function arrayLikeKeys$2(value2, inherited) {
  var isArr = isArray$7(value2), isArg = !isArr && isArguments$1(value2), isBuff = !isArr && !isArg && isBuffer$2(value2), isType = !isArr && !isArg && !isBuff && isTypedArray$1(value2), skipIndexes = isArr || isArg || isBuff || isType, result2 = skipIndexes ? baseTimes(value2.length, String) : [], length = result2.length;
  for (var key in value2) {
    if ((inherited || hasOwnProperty$6.call(value2, key)) && !(skipIndexes && (key == "length" || isBuff && (key == "offset" || key == "parent") || isType && (key == "buffer" || key == "byteLength" || key == "byteOffset") || isIndex$2(key, length)))) {
      result2.push(key);
    }
  }
  return result2;
...
function isArrayLike$2(value2) {
  return value2 != null && isLength$1(value2.length) && !isFunction(value2);
}
...
if (DataView2 && getTag$4(new DataView2(new ArrayBuffer(1))) != dataViewTag$2 || Map$1 && getTag$4(new Map$1()) != mapTag$3 || Promise$1 && getTag$4(Promise$1.resolve()) != promiseTag || Set$1 && getTag$4(new Set$1()) != setTag$3 || WeakMap && getTag$4(new WeakMap()) != weakMapTag$1) {
...
function getMatchData$1(object2) {
  var result2 = keys$2(object2), length = result2.length;
  while (length--) {
    var key = result2[length], value2 = object2[key];
    result2[length] = [key, value2, isStrictComparable$1(value2)];
  }
  return result2;
}
...
var ArgJsDoc = function ArgJsDoc2(_ref136) {
  ...
  var params = (tags.params || []).filter(function(x2) {
  ...
  return import_react.default.createElement(Table, null, import_react.default.createElement("tbody", null, hasDisplayableParams && params.map(function(x2) {
    return import_react.default.createElement("tr", { key: x2.name }, import_react.default.createElement("td", null, import_react.default.createElement("code", null, x2.name)), import_react.default.createElement("td", null, x2.description));
  }), hasDisplayableReturns && import_react.default.createElement("tr", { key: "returns" }, import_react.default.createElement("td", null, import_react.default.createElement("code", null, "Returns")), import_react.default.createElement("td", null, tags.returns.description))));
};
...
var INFINITY = 1 / 0;
var createSet$1 = !(Set && 1 / setToArray$1(new Set([, -0]))[1] == INFINITY) ? noop2 : function(values) {
...
function baseUniq$1(array2, iteratee, comparator) {
  var index2 = -1, includes = arrayIncludes, length = array2.length, isCommon = true, result2 = [], seen = result2;
  if (comparator) {
    isCommon = false;
...
var Text$2 = styled.span(codeCommon, function(_ref138) {
  var theme = _ref138.theme, _ref138$simple = _ref138.simple, simple = _ref138$simple === void 0 ? false : _ref138$simple;
...
var Expandable = styled.div(codeCommon, function(_ref140) {
  ...
  return { fontFamily: theme.typography.fonts.mono, color: theme.color.secondary, fontSize: theme.typography.size.s1, margin: 0, whiteSpace: "nowrap", display: "flex", alignItems: "center" };
});
var Detail = styled.div(function(_ref141) {
  var theme = _ref141.theme, width = _ref141.width;
  return {
    width,
    minWidth: 200,
    maxWidth: 800,
...
var EmptyArg = function EmptyArg2() {
  return import_react.default.createElement("span", null, "-");
};
var ArgText = function ArgText2(_ref142) {
  var text = _ref142.text, simple = _ref142.simple;
  return import_react.default.createElement(Text$2, { simple }, text);
};
var calculateDetailWidth = (0, import_memoizerific.default)(1e3)(function(detail) {
  var lines = detail.split(/\r?\n/);
  return "".concat(Math.max.apply(Math, _toConsumableArray(lines.map(function(x2) {
    return x2.length;
  }))), "ch");
});
...
var renderSummaryItems = function renderSummaryItems2(summaryItems) {
  ...
  return items.map(function(item) {
    return import_react.default.createElement(ArgText, { key: item, text: item === "" ? '""' : item });
  });
};
var ArgSummary = function ArgSummary2(_ref143) {
  ...
  var _useState13 = (0, import_react.useState)(false), _useState14 = _slicedToArray(_useState13, 2), isOpen = _useState14[0], setIsOpen = _useState14[1];
  var _useState15 = (0, import_react.useState)(initialExpandedArgs || false), _useState16 = _slicedToArray(_useState15, 2), isExpanded = _useState16[0], setIsExpanded = _useState16[1];
  ...
  if (detail == null) {
    ...
    return hasManyItems ? import_react.default.createElement(Summary, { isExpanded }, renderSummaryItems(summaryItems, isExpanded), import_react.default.createElement(ExpandButton, { onClick: function onClick() {
      return setIsExpanded(!isExpanded);
    } }, isExpanded ? "Show less..." : "Show ".concat(itemsCount - ITEMS_BEFORE_EXPANSION, " more..."))) : import_react.default.createElement(Summary, null, renderSummaryItems(summaryItems));
  }
  return import_react.default.createElement(WithTooltipPure, { closeOnClick: true, trigger: "click", placement: "bottom", tooltipShown: isOpen, onVisibilityChange: function onVisibilityChange(isVisible) {
    setIsOpen(isVisible);
  }, tooltip: import_react.default.createElement(Detail, { width: calculateDetailWidth(detail) }, import_react.default.createElement(SyntaxHighlighter, { language: "jsx", format: false }, detail)) }, import_react.default.createElement(Expandable, { className: "sbdocs-expandable" }, import_react.default.createElement("span", null, summaryAsString), import_react.default.createElement(ArrowIcon, { icon: isOpen ? "arrowup" : "arrowdown" })));
};
var ArgValue = function ArgValue2(_ref144) {
  var value2 = _ref144.value, initialExpandedArgs = _ref144.initialExpandedArgs;
  return value2 == null ? import_react.default.createElement(EmptyArg, null) : import_react.default.createElement(ArgSummary, { value: value2, initialExpandedArgs });
};
...
var BooleanControl = function BooleanControl2(_ref146) {
  ...
  var onSetFalse = (0, import_react.useCallback)(function() {
  ...
  return import_react.default.createElement(Label$3, { htmlFor: name, title: parsedValue ? "Change to false" : "Change to true" }, import_react.default.createElement("input", Object.assign({ id: getControlId(name), type: "checkbox", onChange: function onChange(e2) {
    return _onChange(e2.target.checked);
  }, checked: parsedValue }, { name, onBlur, onFocus })), import_react.default.createElement("span", null, "False"), import_react.default.createElement("span", null, "True"));
};
var parseDate = function parseDate2(value2) {
  var _value$split = value2.split("-"), _value$split2 = _slicedToArray(_value$split, 3), year = _value$split2[0], month = _value$split2[1], day = _value$split2[2];
...
var parseTime = function parseTime2(value2) {
  var _value$split3 = value2.split(":"), _value$split4 = _slicedToArray(_value$split3, 2), hours = _value$split4[0], minutes = _value$split4[1];
  var result2 = new Date();
...
var FlexSpaced = styled.div(function(_ref147) {
  ...
  return { flex: 1, display: "flex", input: { marginLeft: 10, flex: 1, height: 32, "&::-webkit-calendar-picker-indicator": { opacity: 0.5, height: 12, filter: theme.base === "light" ? void 0 : "invert(1)" } }, "input:first-of-type": { marginLeft: 0, flexGrow: 4 }, "input:last-of-type": { flexGrow: 3 } };
});
var DateControl = function DateControl2(_ref148) {
  ...
  var _useState17 = (0, import_react.useState)(true), _useState18 = _slicedToArray(_useState17, 2), valid = _useState18[0], setValid = _useState18[1];
  var dateRef = (0, import_react.useRef)();
  var timeRef = (0, import_react.useRef)();
  (0, import_react.useEffect)(function() {
    if (valid !== false) {
  ...
  return import_react.default.createElement(FlexSpaced, null, import_react.default.createElement(Form.Input, Object.assign({
    type: "date",
    max: "9999-12-31",
    ref: dateRef,
  ...
  }, { onFocus, onBlur })), import_react.default.createElement(Form.Input, Object.assign({ type: "time", id: "".concat(controlId, "-time"), name: "".concat(controlId, "-time"), ref: timeRef, onChange: onTimeChange }, { onFocus, onBlur })), !valid ? import_react.default.createElement("div", null, "invalid") : null);
};
...
var NumberControl = function NumberControl2(_ref149) {
  var name = _ref149.name, value2 = _ref149.value, onChange = _ref149.onChange, min2 = _ref149.min, max2 = _ref149.max, step = _ref149.step, onBlur = _ref149.onBlur, onFocus = _ref149.onFocus;
  var _useState19 = (0, import_react.useState)(typeof value2 === "number" ? value2 : ""), _useState20 = _slicedToArray(_useState19, 2), inputValue = _useState20[0], setInputValue = _useState20[1];
  var _useState21 = (0, import_react.useState)(false), _useState22 = _slicedToArray(_useState21, 2), forceVisible = _useState22[0], setForceVisible = _useState22[1];
  var _useState23 = (0, import_react.useState)(null), _useState24 = _slicedToArray(_useState23, 2), parseError = _useState24[0], setParseError = _useState24[1];
  ...
  var onForceVisible = (0, import_react.useCallback)(function() {
    setInputValue("0");
    onChange(0);
    setForceVisible(true);
  }, [setForceVisible]);
  var htmlElRef = (0, import_react.useRef)(null);
  (0, import_react.useEffect)(function() {
  ...
  if (!forceVisible && value2 === void 0) {
    return import_react.default.createElement(Form.Button, { id: getControlSetterButtonId(name), onClick: onForceVisible }, "Set number");
  }
  return import_react.default.createElement(Wrapper$5, null, import_react.default.createElement(Form.Input, Object.assign({ ref: htmlElRef, id: getControlId(name), type: "number", onChange: handleChange, size: "flex", placeholder: "Edit number...", value: inputValue, valid: parseError ? "error" : null, autoFocus: forceVisible }, { name, min: min2, max: max2, step, onFocus, onBlur })));
};
...
var selectedKey = function selectedKey2(value2, options) {
  var entry = options && Object.entries(options).find(function(_ref150) {
    var _ref151 = _slicedToArray(_ref150, 2), _key = _ref151[0], val = _ref151[1];
    return val === value2;
  });
...
var CheckboxControl = function CheckboxControl2(_ref153) {
  ...
  var _useState25 = (0, import_react.useState)(initial), _useState26 = _slicedToArray(_useState25, 2), selected = _useState26[0], setSelected = _useState26[1];
  ...
  var controlId = getControlId(name);
  return import_react.default.createElement(Wrapper$4, { isInline }, Object.keys(options).map(function(key, index2) {
    var id = "".concat(controlId, "-").concat(index2);
    return import_react.default.createElement(Label$2, { key: id, htmlFor: id }, import_react.default.createElement("input", { type: "checkbox", id, name: id, value: key, onChange: handleChange, checked: selected === null || selected === void 0 ? void 0 : selected.includes(key) }), import_react.default.createElement(Text$1, null, key));
  }));
};
...
var RadioControl = function RadioControl2(_ref155) {
  ...
  var controlId = getControlId(name);
  return import_react.default.createElement(Wrapper$3, { isInline }, Object.keys(options).map(function(key, index2) {
    var id = "".concat(controlId, "-").concat(index2);
    return import_react.default.createElement(Label$1, { key: id, htmlFor: id }, import_react.default.createElement("input", { type: "radio", id, name: id, value: key, onChange: function onChange(e2) {
      return _onChange2(options[e2.currentTarget.value]);
    }, checked: key === selection }), import_react.default.createElement(Text, null, key));
  }));
};
var styleResets = {
  appearance: "none",
...
var OptionsSelect = styled.select(function(_ref156) {
  ...
  return Object.assign(Object.assign({}, styleResets), { boxSizing: "border-box", position: "relative", padding: "6px 10px", width: "100%", color: theme.input.color || "inherit", background: theme.input.background, borderRadius: theme.input.borderRadius, boxShadow: "".concat(theme.input.border, " 0 0 0 1px inset"), fontSize: theme.typography.size.s2 - 1, lineHeight: "20px", "&:focus": { boxShadow: "".concat(theme.color.secondary, " 0 0 0 1px inset"), outline: "none" }, "&[disabled]": { cursor: "not-allowed", opacity: 0.5 }, "::placeholder": { color: theme.color.mediumdark }, "&[multiple]": { overflow: "auto", padding: 0, option: { display: "block", padding: "6px 10px", marginLeft: 1, marginRight: 1 } } });
});
var SelectWrapper = styled.span(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  display: inline-block;\n  line-height: normal;\n  overflow: hidden;\n  position: relative;\n  vertical-align: top;\n  width: 100%;\n\n  svg {\n    position: absolute;\n    z-index: 1;\n    pointer-events: none;\n    height: 12px;\n    margin-top: -6px;\n    right: 12px;\n    top: 50%;\n\n    path {\n      fill: currentColor;\n    }\n  }\n"])));
...
var SingleSelect = function SingleSelect2(_ref157) {
  ...
  return import_react.default.createElement(SelectWrapper, null, import_react.default.createElement(Icons, { icon: "arrowdown" }), import_react.default.createElement(OptionsSelect, { id: controlId, value: selection, onChange: handleChange }, import_react.default.createElement("option", { key: "no-selection", disabled: true }, NO_SELECTION), Object.keys(options).map(function(key) {
    return import_react.default.createElement("option", { key }, key);
  })));
};
var MultiSelect = function MultiSelect2(_ref158) {
  ...
  var controlId = getControlId(name);
  return import_react.default.createElement(SelectWrapper, null, import_react.default.createElement(OptionsSelect, { id: controlId, multiple: true, value: selection, onChange: handleChange }, Object.keys(options).map(function(key) {
    return import_react.default.createElement("option", { key }, key);
  })));
};
var SelectControl = function SelectControl2(props) {
  ...
  return props.isMulti ? import_react.default.createElement(MultiSelect, Object.assign({}, props)) : import_react.default.createElement(SingleSelect, Object.assign({}, props));
};
...
var OptionsControl = function OptionsControl2(props) {
  ...
  if (Control) {
    return import_react.default.createElement(Control, Object.assign({}, normalized));
  }
...
var JsonAddValue = function(_Component4) {
  ...
  _createClass(JsonAddValue2, [{ key: "componentDidMount", value: function componentDidMount() {
    ...
    var addButtonElementLayout = (0, import_react.cloneElement)(addButtonElement, { onClick: this.onSubmit });
    var cancelButtonElementLayout = (0, import_react.cloneElement)(cancelButtonElement, { onClick: handleCancel });
    var inputElementValue = inputElementGenerator(VALUE, keyPath, deep);
    var inputElementValueLayout = (0, import_react.cloneElement)(inputElementValue, { placeholder: "Value", ref: this.refInputValue });
...
var JsonArray = function(_Component5) {
  ...
  _createClass(JsonArray2, [{ key: "onChildUpdate", value: function onChildUpdate(childKey, childData) {
    ...
    var removeItemButton = (0, import_react.cloneElement)(minusMenuElement, { onClick: handleRemove, className: "rejt-minus-menu", style: minus });
    ...
    var _getStyle2 = getStyle2(name, data, keyPath, deep, dataType), minus = _getStyle2.minus, plus = _getStyle2.plus, delimiter = _getStyle2.delimiter, ul2 = _getStyle2.ul, addForm = _getStyle2.addForm;
    var isReadOnly = readOnly2(name, data, keyPath, deep, dataType);
    var addItemButton = (0, import_react.cloneElement)(plusMenuElement, { onClick: this.handleAddMode, className: "rejt-plus-menu", style: plus });
    var removeItemButton = (0, import_react.cloneElement)(minusMenuElement, { onClick: handleRemove, className: "rejt-minus-menu", style: minus });
    var onlyValue = true;
    var startObject = "[";
    var endObject = "]";
    return import_react.default.createElement("span", { className: "rejt-not-collapsed" }, import_react.default.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, startObject), !addFormVisible && addItemButton, import_react.default.createElement("ul", { className: "rejt-not-collapsed-list", style: ul2 }, data.map(function(item, index2) {
      return import_react.default.createElement(JsonNode, { key: index2, name: "".concat(index2), data: item, keyPath, deep: nextDeep, isCollapsed: isCollapsed2, handleRemove: _this10.handleRemoveItem(index2), handleUpdateValue: _this10.handleEditValue, onUpdate: _this10.onChildUpdate, onDeltaUpdate: onDeltaUpdate2, readOnly: readOnly2, getStyle: getStyle2, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction: beforeRemoveAction2, beforeAddAction: beforeAddAction2, beforeUpdateAction: beforeUpdateAction2, logger: logger2, onSubmitValueParser: onSubmitValueParser2 });
    })), !isReadOnly && addFormVisible && import_react.default.createElement("div", { className: "rejt-add-form", style: addForm }, import_react.default.createElement(JsonAddValue, { handleAdd: this.handleAddValueAdd, handleCancel: this.handleAddValueCancel, onlyValue, addButtonElement, cancelButtonElement, inputElementGenerator, keyPath, deep, onSubmitValueParser: onSubmitValueParser2 })), import_react.default.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, endObject), !isReadOnly && removeItemButton);
  } }, { key: "render", value: function render() {
...
var JsonFunctionValue = function(_Component6) {
  ...
  _createClass(JsonFunctionValue2, [{ key: "componentDidUpdate", value: function componentDidUpdate() {
    ...
    if (editEnabled && !resultOnlyResult) {
      ...
      var editButtonElementLayout = (0, import_react.cloneElement)(editButtonElement, { onClick: this.handleEdit });
      var cancelButtonElementLayout = (0, import_react.cloneElement)(cancelButtonElement, { onClick: this.handleCancelEdit });
      var textareaElementLayout = (0, import_react.cloneElement)(textareaElement2, { ref: this.refInput, defaultValue: originalValue });
      result2 = import_react.default.createElement("span", { className: "rejt-edit-form", style: style.editForm }, textareaElementLayout, " ", cancelButtonElementLayout, editButtonElementLayout);
      minusElement = null;
    } else {
      result2 = import_react.default.createElement("span", { className: "rejt-value", style: style.value, onClick: resultOnlyResult ? null : this.handleEditMode }, value2);
      var minusMenuLayout = (0, import_react.cloneElement)(minusMenuElement, { onClick: handleRemove, className: "rejt-minus-menu", style: style.minus });
      minusElement = resultOnlyResult ? null : minusMenuLayout;
    }
    return import_react.default.createElement("li", { className: "rejt-function-value-node", style: style.li }, import_react.default.createElement("span", { className: "rejt-name", style: style.name }, name, " :", " "), result2, minusElement);
  } }], [{ key: "getDerivedStateFromProps", value: function getDerivedStateFromProps(props, state) {
...
var JsonNode = function(_Component7) {
  ...
  _createClass(JsonNode2, [{ key: "render", value: function render() {
    ...
    switch (dataType) {
      case ERROR:
        return import_react.default.createElement(JsonObject, { data, name, isCollapsed: isCollapsed2, keyPath, deep, handleRemove, onUpdate, onDeltaUpdate: onDeltaUpdate2, readOnly: readOnlyTrue, dataType, getStyle: getStyle2, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction: beforeRemoveAction2, beforeAddAction: beforeAddAction2, beforeUpdateAction: beforeUpdateAction2, logger: logger2, onSubmitValueParser: onSubmitValueParser2 });
      case OBJECT:
        return import_react.default.createElement(JsonObject, { data, name, isCollapsed: isCollapsed2, keyPath, deep, handleRemove, onUpdate, onDeltaUpdate: onDeltaUpdate2, readOnly: readOnly2, dataType, getStyle: getStyle2, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction: beforeRemoveAction2, beforeAddAction: beforeAddAction2, beforeUpdateAction: beforeUpdateAction2, logger: logger2, onSubmitValueParser: onSubmitValueParser2 });
      case ARRAY:
      ...
      case STRING:
        return import_react.default.createElement(JsonValue, { name, value: '"'.concat(data, '"'), originalValue: data, keyPath, deep, handleRemove, handleUpdateValue: handleUpdateValue3, readOnly: readOnly2, dataType, getStyle: getStyle2, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger2, onSubmitValueParser: onSubmitValueParser2 });
      case NUMBER:
        return import_react.default.createElement(JsonValue, { name, value: data, originalValue: data, keyPath, deep, handleRemove, handleUpdateValue: handleUpdateValue3, readOnly: readOnly2, dataType, getStyle: getStyle2, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger2, onSubmitValueParser: onSubmitValueParser2 });
      case BOOLEAN:
        return import_react.default.createElement(JsonValue, { name, value: data ? "true" : "false", originalValue: data, keyPath, deep, handleRemove, handleUpdateValue: handleUpdateValue3, readOnly: readOnly2, dataType, getStyle: getStyle2, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger2, onSubmitValueParser: onSubmitValueParser2 });
      case DATE:
        return import_react.default.createElement(JsonValue, { name, value: data.toISOString(), originalValue: data, keyPath, deep, handleRemove, handleUpdateValue: handleUpdateValue3, readOnly: readOnlyTrue, dataType, getStyle: getStyle2, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger2, onSubmitValueParser: onSubmitValueParser2 });
      case NULL:
        return import_react.default.createElement(JsonValue, { name, value: "null", originalValue: "null", keyPath, deep, handleRemove, handleUpdateValue: handleUpdateValue3, readOnly: readOnly2, dataType, getStyle: getStyle2, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger2, onSubmitValueParser: onSubmitValueParser2 });
      case UNDEFINED:
        return import_react.default.createElement(JsonValue, { name, value: "undefined", originalValue: "undefined", keyPath, deep, handleRemove, handleUpdateValue: handleUpdateValue3, readOnly: readOnly2, dataType, getStyle: getStyle2, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger2, onSubmitValueParser: onSubmitValueParser2 });
      case FUNCTION:
        return import_react.default.createElement(JsonFunctionValue, { name, value: data.toString(), originalValue: data, keyPath, deep, handleRemove, handleUpdateValue: handleUpdateValue3, readOnly: readOnly2, dataType, getStyle: getStyle2, cancelButtonElement, editButtonElement, textareaElementGenerator, minusMenuElement, logger: logger2, onSubmitValueParser: onSubmitValueParser2 });
      case SYMBOL:
        return import_react.default.createElement(JsonValue, { name, value: data.toString(), originalValue: data, keyPath, deep, handleRemove, handleUpdateValue: handleUpdateValue3, readOnly: readOnlyTrue, dataType, getStyle: getStyle2, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger2, onSubmitValueParser: onSubmitValueParser2 });
      default:
        return null;
    }
  } }], [{ key: "getDerivedStateFromProps", value: function getDerivedStateFromProps(props, state) {
...
var JsonObject = function(_Component8) {
  ...
  _createClass(JsonObject2, [{ key: "onChildUpdate", value: function onChildUpdate(childKey, childData) {
    ...
    var _getStyle4 = getStyle2(name, data, keyPath, deep, dataType), minus = _getStyle4.minus, plus = _getStyle4.plus, addForm = _getStyle4.addForm, ul2 = _getStyle4.ul, delimiter = _getStyle4.delimiter;
    var keyList = Object.getOwnPropertyNames(data);
    var isReadOnly = readOnly2(name, data, keyPath, deep, dataType);
    var addItemButton = (0, import_react.cloneElement)(plusMenuElement, { onClick: this.handleAddMode, className: "rejt-plus-menu", style: plus });
    var removeItemButton = (0, import_react.cloneElement)(minusMenuElement, { onClick: handleRemove, className: "rejt-minus-menu", style: minus });
    var list = keyList.map(function(key) {
      return import_react.default.createElement(JsonNode, { key, name: key, data: data[key], keyPath, deep: nextDeep, isCollapsed: isCollapsed2, handleRemove: _this18.handleRemoveValue(key), handleUpdateValue: _this18.handleEditValue, onUpdate: _this18.onChildUpdate, onDeltaUpdate: onDeltaUpdate2, readOnly: readOnly2, getStyle: getStyle2, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction: beforeRemoveAction2, beforeAddAction: beforeAddAction2, beforeUpdateAction: beforeUpdateAction2, logger: logger2, onSubmitValueParser: onSubmitValueParser2 });
    });
    var startObject = "{";
    var endObject = "}";
    return import_react.default.createElement("span", { className: "rejt-not-collapsed" }, import_react.default.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, startObject), !isReadOnly && addItemButton, import_react.default.createElement("ul", { className: "rejt-not-collapsed-list", style: ul2 }, list), !isReadOnly && addFormVisible && import_react.default.createElement("div", { className: "rejt-add-form", style: addForm }, import_react.default.createElement(JsonAddValue, { handleAdd: this.handleAddValueAdd, handleCancel: this.handleAddValueCancel, addButtonElement, cancelButtonElement, inputElementGenerator, keyPath, deep, onSubmitValueParser: onSubmitValueParser2 })), import_react.default.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, endObject), !isReadOnly && removeItemButton);
  } }, { key: "render", value: function render() {
...
var JsonValue = function(_Component9) {
  ...
  _createClass(JsonValue2, [{ key: "componentDidUpdate", value: function componentDidUpdate() {
    ...
    var editButtonElementLayout = (0, import_react.cloneElement)(editButtonElement, { onClick: this.handleEdit });
    var cancelButtonElementLayout = (0, import_react.cloneElement)(cancelButtonElement, { onClick: this.handleCancelEdit });
    var inputElementLayout = (0, import_react.cloneElement)(inputElement2, { ref: this.refInput, defaultValue: JSON.stringify(originalValue) });
    var minusMenuLayout = (0, import_react.cloneElement)(minusMenuElement, { onClick: handleRemove, className: "rejt-minus-menu", style: style.minus });
...
var JsonTree = function(_Component10) {
  ...
  _createClass(JsonTree2, [{ key: "onUpdate", value: function onUpdate(key, data) {
    ...
    if (dataType === "Object" || dataType === "Array") {
      return import_react.default.createElement("div", { className: "rejt-tree" }, import_react.default.createElement(JsonNode, { data, name: rootName, deep: -1, isCollapsed: isCollapsed2, onUpdate: this.onUpdate, onDeltaUpdate: onDeltaUpdate2, readOnly: readOnlyFunction, getStyle: getStyle2, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator: inputElementFunction, textareaElementGenerator: textareaElementFunction, minusMenuElement, plusMenuElement, handleRemove: this.removeRoot, beforeRemoveAction: beforeRemoveAction2, beforeAddAction: beforeAddAction2, beforeUpdateAction: beforeUpdateAction2, logger: logger2, onSubmitValueParser: onSubmitValueParser2 }));
    }
    return fallback;
  } }], [{ key: "getDerivedStateFromProps", value: function getDerivedStateFromProps(props, state) {
...
JsonTree.defaultProps = { rootName: "root", isCollapsed: function isCollapsed(keyPath, deep) {
  ...
  return import_react.default.createElement("textarea", null);
}, fallback: null };
...
var Button = styled.button(function(_ref164) {
  var theme = _ref164.theme, primary = _ref164.primary;
  return { border: 0, height: 20, margin: 1, borderRadius: 4, background: primary ? theme.color.secondary : "transparent", color: primary ? theme.color.lightest : theme.color.dark, fontWeight: primary ? "bold" : "normal", cursor: "pointer", order: primary ? "initial" : 9 };
});
var ActionIcon = styled(Icons)(function(_ref165) {
  var theme = _ref165.theme, icon = _ref165.icon, disabled = _ref165.disabled;
  return { display: "inline-block", verticalAlign: "middle", width: 15, height: 15, padding: 3, marginLeft: 5, cursor: disabled ? "not-allowed" : "pointer", color: theme.color.mediumdark, "&:hover": disabled ? {} : { color: icon === "subtract" ? theme.color.negative : theme.color.ancillary }, "svg + &": { marginLeft: 0 } };
});
var Input = styled.input(function(_ref166) {
  var theme = _ref166.theme, placeholder = _ref166.placeholder;
  return { outline: 0, margin: placeholder ? 1 : "1px 0", padding: "3px 4px", color: theme.color.defaultText, background: theme.background.app, border: "1px solid ".concat(theme.color.border), borderRadius: 4, lineHeight: "14px", width: placeholder === "Key" ? 80 : 120, "&:focus": { border: "1px solid ".concat(theme.color.secondary) } };
});
var RawButton = styled(IconButton)(function(_ref167) {
  var theme = _ref167.theme;
  return { position: "absolute", zIndex: 2, top: 2, right: 2, height: 21, padding: "0 3px", background: theme.background.bar, border: "1px solid ".concat(theme.color.border), borderRadius: 3, color: theme.color.mediumdark, fontSize: "9px", fontWeight: "bold", span: { marginLeft: 3, marginTop: 1 } };
});
var RawInput = styled(Form.Textarea)(function(_ref168) {
  var theme = _ref168.theme;
  return { flex: 1, padding: "7px 6px", fontFamily: theme.typography.fonts.mono, fontSize: "12px", lineHeight: "18px", "&::placeholder": { fontFamily: theme.typography.fonts.base, fontSize: "13px" }, "&:placeholder-shown": { padding: "7px 10px" } };
});
...
var getCustomStyleFunction = function getCustomStyleFunction2(theme) {
  return function() {
...
var ObjectControl = function ObjectControl2(_ref169) {
  ...
  var _useState27 = (0, import_react.useState)(!hasData), _useState28 = _slicedToArray(_useState27, 2), showRaw = _useState28[0], setShowRaw = _useState28[1];
  var _useState29 = (0, import_react.useState)(null), _useState30 = _slicedToArray(_useState29, 2), parseError = _useState30[0], setParseError = _useState30[1];
  var updateRaw = (0, import_react.useCallback)(function(raw) {
    try {
      if (raw)
  ...
  var _useState31 = (0, import_react.useState)(false), _useState32 = _slicedToArray(_useState31, 2), forceVisible = _useState32[0], setForceVisible = _useState32[1];
  var onForceVisible = (0, import_react.useCallback)(function() {
    onChange({});
    setForceVisible(true);
  }, [setForceVisible]);
  ...
  var rawJSONForm = import_react.default.createElement(RawInput, { ref: htmlElRef, id: getControlId(name), name, defaultValue: value2 === null ? "" : JSON.stringify(value2, null, 2), onBlur: function onBlur(event) {
    return updateRaw(event.target.value);
  }, placeholder: "Edit JSON string...", autoFocus: forceVisible, valid: parseError ? "error" : null });
  return import_react.default.createElement(Wrapper$2, null, ["Object", "Array"].includes(getObjectType(data)) && import_react.default.createElement(RawButton, { onClick: function onClick() {
    return setShowRaw(function(v2) {
      return !v2;
    });
  } }, import_react.default.createElement(Icons, { icon: showRaw ? "eyeclose" : "eye" }), import_react.default.createElement("span", null, "RAW")), !showRaw ? import_react.default.createElement(JsonTree, { data, rootName: name, onFullyUpdate: onChange, getStyle: getCustomStyleFunction(theme), cancelButtonElement: import_react.default.createElement(Button, { type: "button" }, "Cancel"), editButtonElement: import_react.default.createElement(Button, { type: "submit" }, "Save"), addButtonElement: import_react.default.createElement(Button, { type: "submit", primary: true }, "Save"), plusMenuElement: import_react.default.createElement(ActionIcon, { icon: "add" }), minusMenuElement: import_react.default.createElement(ActionIcon, { icon: "subtract" }), inputElement: function inputElement2(_, __, ___, key) {
    return key ? import_react.default.createElement(Input, { onFocus: selectValue, onBlur: dispatchEnterKey }) : import_react.default.createElement(Input, null);
  }, fallback: rawJSONForm }) : rawJSONForm);
};
var RangeInput = styled.input(function(_ref170) {
  var theme = _ref170.theme, min2 = _ref170.min, max2 = _ref170.max, value2 = _ref170.value;
  return {
    "&": { width: "100%", backgroundColor: "transparent", appearance: "none" },
    "&::-webkit-slider-runnable-track": { background: theme.base === "light" ? "linear-gradient(to right, \n            ".concat(theme.color.green, " 0%, ").concat(theme.color.green, " ").concat((value2 - min2) / (max2 - min2) * 100, "%, \n            ").concat(curriedDarken$1(0.02, theme.input.background), " ").concat((value2 - min2) / (max2 - min2) * 100, "%, \n            ").concat(curriedDarken$1(0.02, theme.input.background), " 100%)") : "linear-gradient(to right, \n            ".concat(theme.color.green, " 0%, ").concat(theme.color.green, " ").concat((value2 - min2) / (max2 - min2) * 100, "%, \n            ").concat(curriedLighten$1(0.02, theme.input.background), " ").concat((value2 - min2) / (max2 - min2) * 100, "%, \n            ").concat(curriedLighten$1(0.02, theme.input.background), " 100%)"), boxShadow: "".concat(theme.appBorderColor, " 0 0 0 1px inset"), borderRadius: 6, width: "100%", height: 6, cursor: "pointer" },
    ...
    "&:focus": { outline: "none", "&::-webkit-slider-runnable-track": { borderColor: rgba(theme.color.secondary, 0.4) }, "&::-webkit-slider-thumb": { borderColor: theme.color.secondary, boxShadow: "0 0px 5px 0px ".concat(theme.color.secondary) } },
    "&::-moz-range-track": { background: theme.base === "light" ? "linear-gradient(to right, \n            ".concat(theme.color.green, " 0%, ").concat(theme.color.green, " ").concat((value2 - min2) / (max2 - min2) * 100, "%, \n            ").concat(curriedDarken$1(0.02, theme.input.background), " ").concat((value2 - min2) / (max2 - min2) * 100, "%, \n            ").concat(curriedDarken$1(0.02, theme.input.background), " 100%)") : "linear-gradient(to right, \n            ".concat(theme.color.green, " 0%, ").concat(theme.color.green, " ").concat((value2 - min2) / (max2 - min2) * 100, "%, \n            ").concat(curriedLighten$1(0.02, theme.input.background), " ").concat((value2 - min2) / (max2 - min2) * 100, "%, \n            ").concat(curriedLighten$1(0.02, theme.input.background), " 100%)"), boxShadow: "".concat(theme.appBorderColor, " 0 0 0 1px inset"), borderRadius: 6, width: "100%", height: 6, cursor: "pointer", outline: "none" },
    ...
    "&::-ms-track": { background: theme.base === "light" ? "linear-gradient(to right, \n            ".concat(theme.color.green, " 0%, ").concat(theme.color.green, " ").concat((value2 - min2) / (max2 - min2) * 100, "%, \n            ").concat(curriedDarken$1(0.02, theme.input.background), " ").concat((value2 - min2) / (max2 - min2) * 100, "%, \n            ").concat(curriedDarken$1(0.02, theme.input.background), " 100%)") : "linear-gradient(to right, \n            ".concat(theme.color.green, " 0%, ").concat(theme.color.green, " ").concat((value2 - min2) / (max2 - min2) * 100, "%, \n            ").concat(curriedLighten$1(0.02, theme.input.background), " ").concat((value2 - min2) / (max2 - min2) * 100, "%, \n            ").concat(curriedLighten$1(0.02, theme.input.background), " 100%)"), boxShadow: "".concat(theme.appBorderColor, " 0 0 0 1px inset"), color: "transparent", width: "100%", height: "6px", cursor: "pointer" },
    "&::-ms-fill-lower": { borderRadius: 6 },
    "&::-ms-fill-upper": { borderRadius: 6 },
    "&::-ms-thumb": { width: 16, height: 16, background: "".concat(theme.input.background), border: "1px solid ".concat(rgba(theme.appBorderColor, 0.2)), borderRadius: 50, cursor: "grab", marginTop: 0 },
...
var RangeControl = function RangeControl2(_ref171) {
  var name = _ref171.name, value2 = _ref171.value, onChange = _ref171.onChange, _ref171$min = _ref171.min, min2 = _ref171$min === void 0 ? 0 : _ref171$min, _ref171$max = _ref171.max, max2 = _ref171$max === void 0 ? 100 : _ref171$max, _ref171$step = _ref171.step, step = _ref171$step === void 0 ? 1 : _ref171$step, onBlur = _ref171.onBlur, onFocus = _ref171.onFocus;
  var handleChange = function handleChange2(event) {
    onChange(parse$1(event.target.value));
  };
  var hasValue = value2 !== void 0;
  var numberOFDecimalsPlaces = (0, import_react.useMemo)(function() {
    return getNumberOfDecimalPlaces(step);
  }, [step]);
  return import_react.default.createElement(RangeWrapper, null, import_react.default.createElement(RangeLabel, null, min2), import_react.default.createElement(RangeInput, Object.assign({ id: getControlId(name), type: "range", onChange: handleChange }, { name, value: value2, min: min2, max: max2, step, onFocus, onBlur })), import_react.default.createElement(RangeLabel, null, "".concat(hasValue ? value2.toFixed(numberOFDecimalsPlaces) : "--"), " / ", max2));
};
...
var TextControl = function TextControl2(_ref172) {
  ...
  var _useState33 = (0, import_react.useState)(false), _useState34 = _slicedToArray(_useState33, 2), forceVisible = _useState34[0], setForceVisible = _useState34[1];
  var onForceVisible = (0, import_react.useCallback)(function() {
    onChange("");
    setForceVisible(true);
  }, [setForceVisible]);
  ...
  return import_react.default.createElement(Wrapper$1, null, import_react.default.createElement(Form.Textarea, Object.assign({ id: getControlId(name), onChange: handleChange, size: "flex", placeholder: "Edit string...", autoFocus: forceVisible, valid: isValid ? null : "error" }, { name, value: isValid ? value2 : "", onFocus, onBlur })));
};
...
var FilesControl = function FilesControl2(_ref173) {
  ...
  return import_react.default.createElement(FileInput, { id: getControlId(name), type: "file", name, multiple: true, onChange: handleFileChange, accept, size: "flex" });
};
var LazyColorControl = (0, import_react.lazy)(function() {
  return import("./Color-f953d088-LM5QSOY2.js");
});
var ColorControl = function ColorControl2(props) {
  return import_react.default.createElement(import_react.Suspense, { fallback: import_react.default.createElement("div", null) }, import_react.default.createElement(LazyColorControl, Object.assign({}, props)));
};
...
var ArgControl = function ArgControl2(_ref174) {
  ...
  var _useState35 = (0, import_react.useState)(false), _useState36 = _slicedToArray(_useState35, 2), isFocused = _useState36[0], setFocused = _useState36[1];
  var _useState37 = (0, import_react.useState)({ value: arg }), _useState38 = _slicedToArray(_useState37, 2), boxedValue = _useState38[0], setBoxedValue = _useState38[1];
  (0, import_react.useEffect)(function() {
    if (!isFocused)
      setBoxedValue({ value: arg });
  }, [isFocused, arg]);
  var onChange = (0, import_react.useCallback)(function(argVal) {
    setBoxedValue({ value: argVal });
    updateArgs(_defineProperty2({}, key, argVal));
    return argVal;
  }, [updateArgs, key]);
  var onBlur = (0, import_react.useCallback)(function() {
  ...
  return import_react.default.createElement(Control, Object.assign({}, props, control, { controlType: control.type }));
};
...
var Description = styled.div(function(_ref176) {
  ...
  return { "&&": { p: { margin: "0 0 10px 0" }, a: { color: theme.color.secondary } }, code: Object.assign(Object.assign({}, codeCommon({ theme })), { fontSize: 12, fontFamily: theme.typography.fonts.mono }), "& code": { margin: 0, display: "inline-block" }, "& pre > code": { whiteSpace: "pre-wrap" } };
});
var Type = styled.div(function(_ref177) {
  var theme = _ref177.theme, hasDescription = _ref177.hasDescription;
  return { color: theme.base === "light" ? curriedTransparentize$1(0.1, theme.color.defaultText) : curriedTransparentize$1(0.2, theme.color.defaultText), marginTop: hasDescription ? 4 : 0 };
});
var TypeWithJsDoc = styled.div(function(_ref178) {
  var theme = _ref178.theme, hasDescription = _ref178.hasDescription;
  return { color: theme.base === "light" ? curriedTransparentize$1(0.1, theme.color.defaultText) : curriedTransparentize$1(0.2, theme.color.defaultText), marginTop: hasDescription ? 12 : 0, marginBottom: 12 };
});
var StyledTd$1 = styled.td(function(_ref179) {
  var theme = _ref179.theme, expandable = _ref179.expandable;
...
var ArgRow = function ArgRow2(props) {
  ...
  return import_react.default.createElement("tr", null, import_react.default.createElement(StyledTd$1, { expandable }, import_react.default.createElement(Name, null, name), required ? import_react.default.createElement(Required, { title: "Required" }, "*") : null), compact ? null : import_react.default.createElement("td", null, hasDescription && import_react.default.createElement(Description, null, import_react.default.createElement(Markdown, null, description)), table2.jsDocTags != null ? import_react.default.createElement(import_react.default.Fragment, null, import_react.default.createElement(TypeWithJsDoc, { hasDescription }, import_react.default.createElement(ArgValue, { value: type, initialExpandedArgs })), import_react.default.createElement(ArgJsDoc, { tags: table2.jsDocTags })) : import_react.default.createElement(Type, { hasDescription }, import_react.default.createElement(ArgValue, { value: type, initialExpandedArgs }))), compact ? null : import_react.default.createElement("td", null, import_react.default.createElement(ArgValue, { value: defaultValue, initialExpandedArgs })), updateArgs ? import_react.default.createElement("td", null, import_react.default.createElement(ArgControl, Object.assign({}, props))) : null);
};
var ExpanderIcon = styled(Icons)(function(_ref180) {
  var theme = _ref180.theme;
  return { marginRight: 8, marginLeft: -10, marginTop: -2, height: 12, width: 12, color: theme.base === "light" ? curriedTransparentize$1(0.25, theme.color.defaultText) : curriedTransparentize$1(0.3, theme.color.defaultText), border: "none", display: "inline-block" };
});
...
var Section = styled.td(function(_ref182) {
  ...
  return { position: "relative", letterSpacing: "0.35em", textTransform: "uppercase", fontWeight: theme.typography.weight.black, fontSize: theme.typography.size.s1 - 1, color: theme.base === "light" ? curriedTransparentize$1(0.4, theme.color.defaultText) : curriedTransparentize$1(0.6, theme.color.defaultText), background: "".concat(theme.background.app, " !important"), "& ~ td": { background: "".concat(theme.background.app, " !important") } };
});
var Subsection = styled.td(function(_ref183) {
  var theme = _ref183.theme;
  return { position: "relative", fontWeight: theme.typography.weight.bold, fontSize: theme.typography.size.s2 - 1, background: theme.background.content };
});
...
var StyledTr = styled.tr(function(_ref185) {
  ...
  return { "&:hover > td": { backgroundColor: "".concat(theme.background.hoverable, " !important"), boxShadow: "".concat(theme.color.mediumlight, " 0 - 1px 0 0 inset"), cursor: "row-resize" } };
});
...
var SectionRow = function SectionRow2(_ref186) {
  ...
  var _useState39 = (0, import_react.useState)(initialExpanded), _useState40 = _slicedToArray(_useState39, 2), expanded = _useState40[0], setExpanded = _useState40[1];
  ...
  return import_react.default.createElement(import_react.default.Fragment, null, import_react.default.createElement(StyledTr, { title: helperText }, import_react.default.createElement(Level, { colSpan: 1 }, import_react.default.createElement(ClickIntercept, { onClick: function onClick(e2) {
    return setExpanded(!expanded);
  }, tabIndex: 0 }, helperText), import_react.default.createElement(FlexWrapper, null, import_react.default.createElement(ExpanderIcon, { icon }), label)), import_react.default.createElement(StyledTd, { colSpan: colSpan - 1 }, import_react.default.createElement(ClickIntercept, { onClick: function onClick(e2) {
    return setExpanded(!expanded);
...
var TableWrapper = styled.table(function(_ref187) {
  ...
  var theme = _ref187.theme, compact = _ref187.compact, inAddonPanel = _ref187.inAddonPanel;
  return { "&&": (_3 = {
    borderCollapse: "collapse",
    borderSpacing: 0,
    color: theme.color.defaultText,
    ...
    th: { color: theme.base === "light" ? curriedTransparentize$1(0.25, theme.color.defaultText) : curriedTransparentize$1(0.45, theme.color.defaultText), paddingTop: 10, paddingBottom: 10, paddingLeft: 15, paddingRight: 15 },
  ...
  }, _defineProperty2(_3, "tr:first-child", (_trFirstChild = {}, _defineProperty2(_trFirstChild, "td:first-child, th:first-child", { borderTopLeftRadius: inAddonPanel ? 0 : theme.appBorderRadius }), _defineProperty2(_trFirstChild, "td:last-child, th:last-child", { borderTopRightRadius: inAddonPanel ? 0 : theme.appBorderRadius }), _trFirstChild)), _defineProperty2(_3, "tr:last-child", (_trLastChild = {}, _defineProperty2(_trLastChild, "td:first-child, th:first-child", { borderBottomLeftRadius: inAddonPanel ? 0 : theme.appBorderRadius }), _defineProperty2(_trLastChild, "td:last-child, th:last-child", { borderBottomRightRadius: inAddonPanel ? 0 : theme.appBorderRadius }), _trLastChild)), _defineProperty2(_3, "tbody", {
    boxShadow: !inAddonPanel && (theme.base === "light" ? "rgba(0, 0, 0, 0.10) 0 1px 3px 1px,\n          ".concat(curriedTransparentize$1(0.035, theme.appBorderColor), " 0 0 0 1px") : "rgba(0, 0, 0, 0.20) 0 2px 5px 1px,\n          ".concat(curriedOpacify$1(0.05, theme.appBorderColor), " 0 0 0 1px")),
    borderRadius: theme.appBorderRadius,
  ...
  var isLoading = _ref189.isLoading, theme = _ref189.theme;
  return isLoading ? { "th span, td span, td button": { display: "inline", backgroundColor: theme.appBorderColor, animation: "".concat(theme.animation.glow, " 1.5s ease-in-out infinite"), color: "transparent", boxShadow: "none", borderRadius: 0 } } : {};
});
var ResetButton = styled.button(function(_ref190) {
  var theme = _ref190.theme;
  return { border: 0, borderRadius: "3em", cursor: "pointer", display: "inline-block", overflow: "hidden", padding: "3px 8px", transition: "all 150ms ease-out", verticalAlign: "top", userSelect: "none", margin: 0, backgroundColor: theme.base === "light" ? "#EAF3FC" : theme.color.border, boxShadow: theme.base === "light" ? "".concat(theme.color.border, " 0 0 0 1px inset") : "".concat(theme.color.darker, "  0 0 0 1px inset"), color: theme.color.secondary, "&:hover": { background: theme.base === "light" ? curriedDarken$1(0.03, "#EAF3FC") : curriedOpacify$1(0.1, theme.color.border) }, "&:focus": { boxShadow: "".concat(theme.color.secondary, " 0 0 0 1px inset"), outline: "none" }, svg: { display: "block", height: 14, width: 14 } };
});
...
var groupRows = function groupRows2(rows, sort) {
  ...
  Object.entries(rows).forEach(function(_ref191) {
    var _ref192 = _slicedToArray(_ref191, 2), key = _ref192[0], row = _ref192[1];
...
var ArgsTable = function ArgsTable2(props) {
  if ("error" in props) {
    return import_react.default.createElement(EmptyBlock, null, props.error, "\xA0", import_react.default.createElement(Link, { href: "http://storybook.js.org/docs/", target: "_blank", withArrow: true }, "Read the docs"));
  }
  ...
  if (groups.ungrouped.length === 0 && Object.entries(groups.sections).length === 0 && Object.entries(groups.ungroupedSubsections).length === 0) {
    return import_react.default.createElement(EmptyBlock, null, "No inputs found for this component.\xA0", import_react.default.createElement(Link, { href: "http://storybook.js.org/docs/", target: "_blank", withArrow: true }, "Read the docs"));
  }
  var colSpan = 1;
  if (updateArgs)
    colSpan += 1;
  ...
  return import_react.default.createElement(ResetWrapper, null, import_react.default.createElement(TableWrapper, Object.assign({ "aria-hidden": isLoading }, { compact, inAddonPanel, isLoading }, { className: "docblock-argstable" }), import_react.default.createElement("thead", { className: "docblock-argstable-head" }, import_react.default.createElement("tr", null, import_react.default.createElement("th", null, import_react.default.createElement("span", null, "Name")), compact ? null : import_react.default.createElement("th", null, import_react.default.createElement("span", null, "Description")), compact ? null : import_react.default.createElement("th", null, import_react.default.createElement("span", null, "Default")), updateArgs ? import_react.default.createElement("th", null, import_react.default.createElement(ControlHeadingWrapper, null, "Control", " ", !isLoading && resetArgs && import_react.default.createElement(ResetButton, { onClick: function onClick() {
    return resetArgs();
  }, title: "Reset controls" }, import_react.default.createElement(Icons, { icon: "undo", "aria-hidden": true })))) : null)), import_react.default.createElement("tbody", { className: "docblock-argstable-body" }, groups.ungrouped.map(function(row) {
    return import_react.default.createElement(ArgRow, Object.assign({ key: row.key, row, arg: args && args[row.key] }, common));
  }), Object.entries(groups.ungroupedSubsections).map(function(_ref195) {
    var _ref196 = _slicedToArray(_ref195, 2), subcategory = _ref196[0], subsection = _ref196[1];
    return import_react.default.createElement(SectionRow, { key: subcategory, label: subcategory, level: "subsection", colSpan }, subsection.map(function(row) {
      return import_react.default.createElement(ArgRow, Object.assign({ key: row.key, row, arg: args && args[row.key], expandable }, common));
    }));
  }), Object.entries(groups.sections).map(function(_ref197) {
    var _ref198 = _slicedToArray(_ref197, 2), category = _ref198[0], section = _ref198[1];
    return import_react.default.createElement(SectionRow, { key: category, label: category, level: "section", colSpan }, section.ungrouped.map(function(row) {
      return import_react.default.createElement(ArgRow, Object.assign({ key: row.key, row, arg: args && args[row.key] }, common));
    }), Object.entries(section.subsections).map(function(_ref199) {
      var _ref200 = _slicedToArray(_ref199, 2), subcategory = _ref200[0], subsection = _ref200[1];
      return import_react.default.createElement(SectionRow, { key: subcategory, label: subcategory, level: "subsection", colSpan }, subsection.map(function(row) {
        return import_react.default.createElement(ArgRow, Object.assign({ key: row.key, row, arg: args && args[row.key], expandable }, common));
      }));
    }));
...
var TabbedArgsTable = function TabbedArgsTable2(_a) {
  ...
  if (entries.length === 1) {
    return import_react.default.createElement(ArgsTable, Object.assign({}, entries[0][1], props));
  }
  return import_react.default.createElement(TabsState, null, entries.map(function(entry) {
    var _entry = _slicedToArray(entry, 2), label = _entry[0], table2 = _entry[1];
    var id = "prop_table_div_".concat(label);
    return import_react.default.createElement("div", { key: id, id, title: label }, function(_ref201) {
      var active = _ref201.active;
      return active ? import_react.default.createElement(ArgsTable, Object.assign({ key: "prop_table_".concat(label) }, table2, props)) : null;
    });
  }));
};
var NoControlsWrapper = styled.div(function(_ref202) {
  var theme = _ref202.theme;
  return { background: theme.background.warning, color: theme.color.darkest, padding: "10px 15px", lineHeight: "20px", boxShadow: "".concat(theme.appBorderColor, " 0 -1px 0 0 inset") };
});
var NoControlsWarning = function NoControlsWarning2() {
  return import_react.default.createElement(NoControlsWrapper, null, "This story is not configured to handle controls.", " ", import_react.default.createElement(Link, { href: "https://storybook.js.org/docs/react/essentials/controls", target: "_blank", cancel: false, withArrow: true }, "Learn how to add controls"));
};
var Label = styled.div(function(_ref203) {
  var theme = _ref203.theme;
  return { marginRight: 30, fontSize: "".concat(theme.typography.size.s1, "px"), color: theme.base === "light" ? curriedTransparentize$1(0.4, theme.color.defaultText) : curriedTransparentize$1(0.6, theme.color.defaultText) };
});
...
var Wrapper = styled.div(withReset, function(_ref204) {
  var theme = _ref204.theme;
  return Object.assign(Object.assign({}, getBlockBackgroundStyle(theme)), { margin: "25px 0 40px", padding: "30px 20px" });
});
var Typeset = function Typeset2(_a) {
  ...
  return import_react.default.createElement(Wrapper, Object.assign({}, props, { className: "docblock-typeset" }), fontSizes.map(function(size) {
    return import_react.default.createElement(TypeSpecimen, { key: size }, import_react.default.createElement(Label, null, size), import_react.default.createElement(Sample, { style: { fontFamily, fontSize: size, fontWeight, lineHeight: 1.2 } }, sampleText || "Was he a beast if music could move him so?"));
  }));
};
...
var ItemSubtitle = styled.div(function(_ref206) {
  ...
  return { color: theme.base === "light" ? curriedTransparentize$1(0.2, theme.color.defaultText) : curriedTransparentize$1(0.6, theme.color.defaultText) };
});
...
var SwatchLabel = styled.div(function(_ref207) {
  ...
  return { flex: 1, textAlign: "center", fontFamily: theme.typography.fonts.mono, fontSize: theme.typography.size.s1, lineHeight: 1, overflow: "hidden", color: theme.base === "light" ? curriedTransparentize$1(0.4, theme.color.defaultText) : curriedTransparentize$1(0.6, theme.color.defaultText), "> div": { display: "inline-block", overflow: "hidden", maxWidth: "100%", textOverflow: "ellipsis" }, span: { display: "block", marginTop: 2 } };
});
var SwatchLabels = styled.div({ display: "flex", flexDirection: "row" });
var Swatch = styled.div(function(_ref208) {
  var background = _ref208.background;
  return { position: "relative", flex: 1, "&::before": { position: "absolute", top: 0, left: 0, width: "100%", height: "100%", background, content: '""' } };
});
var SwatchColors = styled.div(function(_ref209) {
  var theme = _ref209.theme;
  return Object.assign(Object.assign({}, getBlockBackgroundStyle(theme)), { display: "flex", flexDirection: "row", height: 50, marginBottom: 5, overflow: "hidden", backgroundColor: "white", backgroundImage: "repeating-linear-gradient(-45deg, #ccc, #ccc 1px, #fff 1px, #fff 16px)", backgroundClip: "padding-box" });
});
...
var ListHeading = styled.div(function(_ref210) {
  ...
  return { display: "flex", flexDirection: "row", alignItems: "center", paddingBottom: 20, fontWeight: theme.typography.weight.bold, color: theme.base === "light" ? curriedTransparentize$1(0.4, theme.color.defaultText) : curriedTransparentize$1(0.6, theme.color.defaultText) };
});
var List$1 = styled.div(function(_ref211) {
  var theme = _ref211.theme;
  return { fontSize: theme.typography.size.s2, lineHeight: "20px", display: "flex", flexDirection: "column" };
});
function renderSwatch(color, index2) {
  return import_react.default.createElement(Swatch, { key: "".concat(color, "-").concat(index2), title: color, background: color });
}
function renderSwatchLabel(color, index2, colorDescription) {
  return import_react.default.createElement(SwatchLabel, { key: "".concat(color, "-").concat(index2), title: color }, import_react.default.createElement("div", null, color, colorDescription && import_react.default.createElement("span", null, colorDescription)));
}
function renderSwatchSpecimen(colors) {
  if (Array.isArray(colors)) {
    return import_react.default.createElement(SwatchSpecimen, null, import_react.default.createElement(SwatchColors, null, colors.map(function(color, index2) {
      return renderSwatch(color, index2);
    })), import_react.default.createElement(SwatchLabels, null, colors.map(function(color, index2) {
      return renderSwatchLabel(color, index2);
    })));
  }
  return import_react.default.createElement(SwatchSpecimen, null, import_react.default.createElement(SwatchColors, null, Object.values(colors).map(function(color, index2) {
    return renderSwatch(color, index2);
  })), import_react.default.createElement(SwatchLabels, null, Object.keys(colors).map(function(color, index2) {
    return renderSwatchLabel(color, index2, colors[color]);
  })));
}
var ColorItem = function ColorItem2(_ref212) {
  var title = _ref212.title, subtitle = _ref212.subtitle, colors = _ref212.colors;
  return import_react.default.createElement(Item$1, null, import_react.default.createElement(ItemDescription, null, import_react.default.createElement(ItemTitle, null, title), import_react.default.createElement(ItemSubtitle, null, subtitle)), import_react.default.createElement(Swatches, null, renderSwatchSpecimen(colors)));
};
var ColorPalette = function ColorPalette2(_a) {
  var children = _a.children, props = __rest(_a, ["children"]);
  return import_react.default.createElement(ResetWrapper, null, import_react.default.createElement(List$1, Object.assign({}, props, { className: "docblock-colorpalette" }), import_react.default.createElement(ListHeading, null, import_react.default.createElement(ListName, null, "Name"), import_react.default.createElement(ListSwatches, null, "Swatches")), children));
};
var ItemLabel = styled.div(function(_ref213) {
  var theme = _ref213.theme;
  return { fontFamily: theme.typography.fonts.base, fontSize: theme.typography.size.s2, color: theme.color.defaultText, marginLeft: 10, lineHeight: 1.2 };
});
var ItemSpecimen = styled.div(function(_ref214) {
  var theme = _ref214.theme;
  return Object.assign(Object.assign({}, getBlockBackgroundStyle(theme)), { overflow: "hidden", height: 40, width: 40, display: "flex", alignItems: "center", justifyContent: "center", flex: "none", "> img, > svg": { width: 20, height: 20 } });
});
...
var IconItem = function IconItem2(_ref215) {
  ...
  return import_react.default.createElement(Item, null, import_react.default.createElement(ItemSpecimen, null, children), import_react.default.createElement(ItemLabel, null, name));
};
var IconGallery = function IconGallery2(_a) {
  var children = _a.children, props = __rest(_a, ["children"]);
  return import_react.default.createElement(ResetWrapper, null, import_react.default.createElement(List, Object.assign({}, props, { className: "docblock-icongallery" }), children));
};
var components = components$1;
var resetComponents = {};
Object.keys(components$1).forEach(function(key) {
  resetComponents[key] = (0, import_react.forwardRef)(function(props, ref) {
    return (0, import_react.createElement)(key, Object.assign(Object.assign({}, props), { ref }));
  });
});
...
***************************************************************************** */
//# sourceMappingURL=chunk-FKPMBEBZ.js.map
